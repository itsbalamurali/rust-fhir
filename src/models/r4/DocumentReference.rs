...
use crate::models::r4::DocumentReference_Content::DocumentReference_Content;
use crate::models::r4::DocumentReference_Context::DocumentReference_Context;
use crate::models::r4::DocumentReference_RelatesTo::DocumentReference_RelatesTo;
