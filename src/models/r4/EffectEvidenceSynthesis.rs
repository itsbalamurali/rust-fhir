...
use crate::models::r4::EffectEvidenceSynthesis_Certainty::EffectEvidenceSynthesis_Certainty;
use crate::models::r4::EffectEvidenceSynthesis_EffectEstimate::EffectEvidenceSynthesis_EffectEstimate;
use crate::models::r4::EffectEvidenceSynthesis_ResultsByExposure::EffectEvidenceSynthesis_ResultsByExposure;
use crate::models::r4::EffectEvidenceSynthesis_SampleSize::EffectEvidenceSynthesis_SampleSize;
...
/// between exposures states in a population where the effect estimate is derived from
...
impl EffectEvidenceSynthesis<'_> {
    ...
    /// to assist with indexing and searching for appropriate effect evidence synthesis
    /// instances.
