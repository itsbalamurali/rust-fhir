...
use crate::models::r4::Encounter_ClassHistory::Encounter_ClassHistory;
use crate::models::r4::Encounter_Diagnosis::Encounter_Diagnosis;
use crate::models::r4::Encounter_Hospitalization::Encounter_Hospitalization;
use crate::models::r4::Encounter_Location::Encounter_Location;
use crate::models::r4::Encounter_Participant::Encounter_Participant;
use crate::models::r4::Encounter_StatusHistory::Encounter_StatusHistory;
