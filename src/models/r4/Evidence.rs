...
impl Evidence<'_> {
    ...
    /// A formal identifier that is used to identify this evidence when it is represented
    ...
    /// Descriptive topics related to the content of the Evidence. Topics provide a high-
    /// level categorization grouping types of Evidences that can be useful for filtering
    /// and searching.
    ...
    /// an authoritative instance of this evidence is (or will be) published. This URL can
