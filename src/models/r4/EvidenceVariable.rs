...
use crate::models::r4::EvidenceVariable_Characteristic::EvidenceVariable_Characteristic;
...
impl EvidenceVariable<'_> {
    ...
    /// Descriptive topics related to the content of the EvidenceVariable. Topics provide
    /// a high-level categorization grouping types of EvidenceVariables that can be useful
