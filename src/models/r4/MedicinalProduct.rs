...
use crate::models::r4::MarketingStatus::MarketingStatus;
use crate::models::r4::MedicinalProduct_ManufacturingBusinessOperation::MedicinalProduct_ManufacturingBusinessOperation;
use crate::models::r4::MedicinalProduct_Name::MedicinalProduct_Name;
use crate::models::r4::MedicinalProduct_SpecialDesignation::MedicinalProduct_SpecialDesignation;
...
impl MedicinalProduct<'_> {
    ...
    /// Indicates if the medicinal product has an orphan designation for the treatment of
    /// a rare disease.
