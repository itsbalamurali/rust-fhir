...
use crate::models::r4::MedicinalProductIngredient_Strength::MedicinalProductIngredient_Strength;
use serde_json::json;
...
impl MedicinalProductIngredient_Substance<'_> {
    ...
    /// Quantity of the substance or specified substance present in the manufactured item
