...
use crate::models::r4::MedicinalProductInteraction_Interactant::MedicinalProductInteraction_Interactant;
...
/// The interactions of the medicinal product with other medicinal products, or other
