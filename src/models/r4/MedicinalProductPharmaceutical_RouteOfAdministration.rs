...
use crate::models::r4::MedicinalProductPharmaceutical_TargetSpecies::MedicinalProductPharmaceutical_TargetSpecies;
...
impl MedicinalProductPharmaceutical_RouteOfAdministration<'_> {
    ...
    /// The maximum dose per day (maximum dose quantity to be administered in any one 24-
    /// h period) that can be administered as per the protocol referenced in the clinical
    /// trial authorisation.
