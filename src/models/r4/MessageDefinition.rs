...
use crate::models::r4::MessageDefinition_AllowedResponse::MessageDefinition_AllowedResponse;
use crate::models::r4::MessageDefinition_Focus::MessageDefinition_Focus;
...
impl MessageDefinition<'_> {
    ...
    /// canonical reference to a [[[GraphDefinition]]] that it controls what resources are
    /// to be added to the bundle when building the document. The GraphDefinition can also
    /// specify profiles that apply to the various resources.
