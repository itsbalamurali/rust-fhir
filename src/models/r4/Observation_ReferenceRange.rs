...
impl Observation_ReferenceRange<'_> {
    ...
    /// the low bound is omitted,  it is assumed to be meaningless (e.g. reference range
    /// is <=2.3).
    ...
    /// range is not appropriate for an observation.  An example would be a reference
    /// value of "Negative" or a list or table of "normals".
