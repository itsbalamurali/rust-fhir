...
use crate::models::r4::PractitionerRole_AvailableTime::PractitionerRole_AvailableTime;
use crate::models::r4::PractitionerRole_NotAvailable::PractitionerRole_NotAvailable;
