...
use crate::models::r4::RiskEvidenceSynthesis_Certainty::RiskEvidenceSynthesis_Certainty;
use crate::models::r4::RiskEvidenceSynthesis_RiskEstimate::RiskEvidenceSynthesis_RiskEstimate;
use crate::models::r4::RiskEvidenceSynthesis_SampleSize::RiskEvidenceSynthesis_SampleSize;
...
impl RiskEvidenceSynthesis<'_> {
    ...
    /// A formal identifier that is used to identify this risk evidence synthesis when it
    ...
    /// A natural language name identifying the risk evidence synthesis. This name should
    ...
    /// reference. It SHALL remain the same when the risk evidence synthesis is stored on
    /// different servers.
    ...
    /// to assist with indexing and searching for appropriate risk evidence synthesis
    /// instances.
