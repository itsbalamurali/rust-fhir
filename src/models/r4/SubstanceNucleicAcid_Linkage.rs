...
impl SubstanceNucleicAcid_Linkage<'_> {
    ...
    /// nearly all naturally occurring nucleic acid the linkage is a phosphate group. For
    /// many synthetic oligonucleotides phosphorothioate linkages are often seen. Linkage
    /// connectivity is assumed to be 3’-5’. If the linkage is either 3’-3’ or 5’-5’ this
    /// should be specified.
