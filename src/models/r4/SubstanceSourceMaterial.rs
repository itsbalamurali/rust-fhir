...
use crate::models::r4::SubstanceSourceMaterial_FractionDescription::SubstanceSourceMaterial_FractionDescription;
use crate::models::r4::SubstanceSourceMaterial_Organism::SubstanceSourceMaterial_Organism;
use crate::models::r4::SubstanceSourceMaterial_PartDescription::SubstanceSourceMaterial_PartDescription;
use serde_json::json;
...
impl SubstanceSourceMaterial<'_> {
    ...
    /// Group 1 Substances. For substances derived from Plants, fraction information will
    /// be captured at the Substance information level ( . Oils, Juices and Exudates).
    /// Additional information for Extracts, such as extraction solvent composition, will
    /// be captured at the Specified Substance Group 1 information level. For plasma-
    /// derived products fraction information will be captured at the Substance and the
