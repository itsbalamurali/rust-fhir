...
impl SubstanceSourceMaterial_Author<'_> {
    ...
    /// organism shall also be specified when applicable; refers to the year in which the
    /// first author(s) published the infraspecific plant/animal name (of any rank).
    ...
    /// author of an organism species refers to the first author who published the plant/
    /// animal name (of any rank). The primary author of an organism species refers to the
    /// first author(s), who validly published the plant/animal name.
