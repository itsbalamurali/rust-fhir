...
use crate::models::r4::VerificationResult_Attestation::VerificationResult_Attestation;
use crate::models::r4::VerificationResult_PrimarySource::VerificationResult_PrimarySource;
use crate::models::r4::VerificationResult_Validator::VerificationResult_Validator;
use serde_json::json;
