...
impl ActivityDefinition_DynamicValue<'_> {
    ...
    /// specified path SHALL be a FHIRPath resolveable on the specified target type of the
    /// ActivityDefinition, and SHALL consist only of identifiers, constant indexers, and
    /// a restricted subset of functions. The path is allowed to contain qualifiers (.) to
