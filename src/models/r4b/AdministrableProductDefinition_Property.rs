...
#[derive(Debug)]
pub struct AdministrableProductDefinition_Property<'a> {
    pub(crate) value: Cow<'a, Value>,
}

impl AdministrableProductDefinition_Property<'_> {
    pub fn new(value: &Value) -> AdministrableProductDefinition_Property {
...
#[derive(Debug)]
pub struct AdministrableProductDefinition_PropertyBuilder {
    pub(crate) value: Value,
}

impl AdministrableProductDefinition_PropertyBuilder {
    pub fn build(&self) -> AdministrableProductDefinition_Property {
        AdministrableProductDefinition_Property {
    ...
    pub fn with(
        existing: AdministrableProductDefinition_Property,
    ) -> AdministrableProductDefinition_PropertyBuilder {
        AdministrableProductDefinition_PropertyBuilder {
            value: (*existing.value).clone(),
        }
    }

    pub fn new(fhir_type: CodeableConcept) -> AdministrableProductDefinition_PropertyBuilder {
        let mut __value: Value = json!({});
        __value["type"] = json!(fhir_type.value);
        return AdministrableProductDefinition_PropertyBuilder { value: __value };
    }

    pub fn _value_boolean<'a>(
        &'a mut self,
        val: Element,
    ) -> &'a mut AdministrableProductDefinition_PropertyBuilder {
