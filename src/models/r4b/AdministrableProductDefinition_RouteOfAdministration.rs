...
use crate::models::r4b::AdministrableProductDefinition_TargetSpecies::AdministrableProductDefinition_TargetSpecies;
...
#[derive(Debug)]
pub struct AdministrableProductDefinition_RouteOfAdministration<'a> {
    pub(crate) value: Cow<'a, Value>,
}

impl AdministrableProductDefinition_RouteOfAdministration<'_> {
    pub fn new(value: &Value) -> AdministrableProductDefinition_RouteOfAdministration {
    ...
    pub fn target_species(&self) -> Option<Vec<AdministrableProductDefinition_TargetSpecies>> {
        if let Some(Value::Array(val)) = self.value.get("targetSpecies") {
            return Some(
                val.into_iter()
                    .map(|e| AdministrableProductDefinition_TargetSpecies {
                        value: Cow::Borrowed(e),
                    })
                    .collect::<Vec<_>>(),
            );
...
#[derive(Debug)]
pub struct AdministrableProductDefinition_RouteOfAdministrationBuilder {
    pub(crate) value: Value,
}

impl AdministrableProductDefinition_RouteOfAdministrationBuilder {
    pub fn build(&self) -> AdministrableProductDefinition_RouteOfAdministration {
        AdministrableProductDefinition_RouteOfAdministration {
    ...
    pub fn with(
        existing: AdministrableProductDefinition_RouteOfAdministration,
    ) -> AdministrableProductDefinition_RouteOfAdministrationBuilder {
        AdministrableProductDefinition_RouteOfAdministrationBuilder {
    ...
    pub fn new(
        ...
        return AdministrableProductDefinition_RouteOfAdministrationBuilder { value: __value };
    }

    pub fn extension<'a>(
        &'a mut self,
        val: Vec<Extension>,
    ) -> &'a mut AdministrableProductDefinition_RouteOfAdministrationBuilder {
    ...
    pub fn target_species<'a>(
        &'a mut self,
        val: Vec<AdministrableProductDefinition_TargetSpecies>,
    ) -> &'a mut AdministrableProductDefinition_RouteOfAdministrationBuilder {
