...
use crate::models::r4b::AdverseEvent_SuspectEntity::AdverseEvent_SuspectEntity;
...
impl AdverseEvent<'_> {
    ...
    /// perform the activity (e.g. consultant), information that the activity itself seeks
    /// to reveal (e.g. informant of clinical history), or information about what activity
    /// was performed (e.g. informant witness).
    ...
    /// Describes the severity of the adverse event, in relation to the subject. Contrast
    /// to AdverseEvent.seriousness - a severe rash might not be serious, but a mild heart
    /// problem is.
