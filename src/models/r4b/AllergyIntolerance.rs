...
use crate::models::r4b::AllergyIntolerance_Reaction::AllergyIntolerance_Reaction;
...
impl AllergyIntolerance<'_> {
    ...
    pub fn category(&self) -> Option<Vec<&str>> {
    ...
    pub fn criticality(&self) -> Option<&str> {
        if let Some(Value::String(string)) = self.value.get("criticality") {
            return Some(string);
        }
        return None;
    }
...
impl AllergyIntoleranceBuilder {
    ...
    pub fn category<'a>(&'a mut self, val: Vec<&str>) -> &'a mut AllergyIntoleranceBuilder {
    ...
    pub fn criticality<'a>(&'a mut self, val: &str) -> &'a mut AllergyIntoleranceBuilder {
        self.value["criticality"] = json!(val);
        return self;
    }
    ...
    pub fn fhir_type<'a>(&'a mut self, val: &str) -> &'a mut AllergyIntoleranceBuilder {
