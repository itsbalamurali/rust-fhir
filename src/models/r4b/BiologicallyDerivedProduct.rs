...
use crate::models::r4b::BiologicallyDerivedProduct_Collection::BiologicallyDerivedProduct_Collection;
use crate::models::r4b::BiologicallyDerivedProduct_Manipulation::BiologicallyDerivedProduct_Manipulation;
use crate::models::r4b::BiologicallyDerivedProduct_Processing::BiologicallyDerivedProduct_Processing;
use crate::models::r4b::BiologicallyDerivedProduct_Storage::BiologicallyDerivedProduct_Storage;
...
impl BiologicallyDerivedProduct<'_> {
    ...
    /// For example a buffy-coat enrichment or CD8 reduction of Peripheral Blood Stem
