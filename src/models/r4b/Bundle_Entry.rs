...
use crate::models::r4b::Bundle_Link::Bundle_Link;
use crate::models::r4b::Bundle_Request::Bundle_Request;
use crate::models::r4b::Bundle_Response::Bundle_Response;
use crate::models::r4b::Bundle_Search::Bundle_Search;
...
impl Bundle_Entry<'_> {
    ...
    /// independent reference to the resource. The fullUrl element SHALL have a value
    /// except that:   * fullUrl can be empty on a POST (although it does not need to when
    /// specifying a temporary id for reference in the bundle)  * Results from operations
