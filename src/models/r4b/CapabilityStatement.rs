...
use crate::models::r4b::CapabilityStatement_Document::CapabilityStatement_Document;
use crate::models::r4b::CapabilityStatement_Implementation::CapabilityStatement_Implementation;
use crate::models::r4b::CapabilityStatement_Messaging::CapabilityStatement_Messaging;
use crate::models::r4b::CapabilityStatement_Rest::CapabilityStatement_Rest;
use crate::models::r4b::CapabilityStatement_Software::CapabilityStatement_Software;
...
impl CapabilityStatementBuilder {
    ...
    pub fn fhir_version<'a>(&'a mut self, val: &str) -> &'a mut CapabilityStatementBuilder {
    ...
    pub fn kind<'a>(&'a mut self, val: &str) -> &'a mut CapabilityStatementBuilder {
    ...
    pub fn status<'a>(&'a mut self, val: &str) -> &'a mut CapabilityStatementBuilder {
