...
use crate::models::r4b::CapabilityStatement_Interaction::CapabilityStatement_Interaction;
use crate::models::r4b::CapabilityStatement_Operation::CapabilityStatement_Operation;
use crate::models::r4b::CapabilityStatement_SearchParam::CapabilityStatement_SearchParam;
...
impl CapabilityStatement_Resource<'_> {
    ...
    pub fn conditional_delete(&self) -> Option<&str> {
        if let Some(Value::String(string)) = self.value.get("conditionalDelete") {
            return Some(string);
        }
        return None;
    }
    ...
    pub fn conditional_read(&self) -> Option<&str> {
        if let Some(Value::String(string)) = self.value.get("conditionalRead") {
            return Some(string);
        }
        return None;
    }
    ...
    pub fn reference_policy(&self) -> Option<Vec<&str>> {
        if let Some(Value::Array(val)) = self.value.get("referencePolicy") {
            return Some(
                val.into_iter()
    ...
    pub fn versioning(&self) -> Option<&str> {
        if let Some(Value::String(string)) = self.value.get("versioning") {
            return Some(string);
        }
        return None;
    }
    ...
    pub fn validate(&self) -> bool {
        ...
        if let Some(_val) = self.reference_policy() {
...
impl CapabilityStatement_ResourceBuilder {
    ...
    pub fn conditional_delete<'a>(
        ...
        self.value["conditionalDelete"] = json!(val);
        return self;
    }
    ...
    pub fn conditional_read<'a>(
        ...
        self.value["conditionalRead"] = json!(val);
        return self;
    }
    ...
    pub fn reference_policy<'a>(
        &'a mut self,
        val: Vec<&str>,
    ) -> &'a mut CapabilityStatement_ResourceBuilder {
        self.value["referencePolicy"] = json!(val);
        return self;
    }
    ...
    pub fn versioning<'a>(&'a mut self, val: &str) -> &'a mut CapabilityStatement_ResourceBuilder {
        self.value["versioning"] = json!(val);
        return self;
    }
}
