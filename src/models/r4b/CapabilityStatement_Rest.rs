...
use crate::models::r4b::CapabilityStatement_Interaction1::CapabilityStatement_Interaction1;
use crate::models::r4b::CapabilityStatement_Operation::CapabilityStatement_Operation;
use crate::models::r4b::CapabilityStatement_Resource::CapabilityStatement_Resource;
use crate::models::r4b::CapabilityStatement_SearchParam::CapabilityStatement_SearchParam;
use crate::models::r4b::CapabilityStatement_Security::CapabilityStatement_Security;
...
impl CapabilityStatement_RestBuilder {
    ...
    pub fn mode<'a>(&'a mut self, val: &str) -> &'a mut CapabilityStatement_RestBuilder {
