...
use crate::models::r4b::CatalogEntry_RelatedEntry::CatalogEntry_RelatedEntry;
...
impl CatalogEntry<'_> {
    ...
    /// Typically date of issue is different from the beginning of the validity. This can
    /// be used to see when an item was last updated.
    ...
    /// Used to support catalog exchange even for unsupported products, e.g. getting list
    /// of medications even if not prescribable.
...
impl CatalogEntryBuilder {
    ...
    pub fn status<'a>(&'a mut self, val: &str) -> &'a mut CatalogEntryBuilder {
