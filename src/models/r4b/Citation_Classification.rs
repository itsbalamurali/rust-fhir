...
#[derive(Debug)]
pub struct Citation_Classification<'a> {
    pub(crate) value: Cow<'a, Value>,
}

impl Citation_Classification<'_> {
    pub fn new(value: &Value) -> Citation_Classification {
...
#[derive(Debug)]
pub struct Citation_ClassificationBuilder {
    pub(crate) value: Value,
}

impl Citation_ClassificationBuilder {
    pub fn build(&self) -> Citation_Classification {
        Citation_Classification {
            value: Cow::Owned(self.value.clone()),
        }
    }

    pub fn with(existing: Citation_Classification) -> Citation_ClassificationBuilder {
        Citation_ClassificationBuilder {
            value: (*existing.value).clone(),
        }
    }

    pub fn new() -> Citation_ClassificationBuilder {
        let mut __value: Value = json!({});
        return Citation_ClassificationBuilder { value: __value };
    }

    pub fn classifier<'a>(
        &'a mut self,
        val: Vec<CodeableConcept>,
    ) -> &'a mut Citation_ClassificationBuilder {
    ...
    pub fn id<'a>(&'a mut self, val: &str) -> &'a mut Citation_ClassificationBuilder {
