...
#[derive(Debug)]
pub struct Citation_RelatesTo1<'a> {
    pub(crate) value: Cow<'a, Value>,
}

impl Citation_RelatesTo1<'_> {
    pub fn new(value: &Value) -> Citation_RelatesTo1 {
        Citation_RelatesTo1 {
...
#[derive(Debug)]
pub struct Citation_RelatesTo1Builder {
    pub(crate) value: Value,
}

impl Citation_RelatesTo1Builder {
    pub fn build(&self) -> Citation_RelatesTo1 {
        Citation_RelatesTo1 {
            value: Cow::Owned(self.value.clone()),
        }
    }

    pub fn with(existing: Citation_RelatesTo1) -> Citation_RelatesTo1Builder {
        Citation_RelatesTo1Builder {
            value: (*existing.value).clone(),
        }
    }

    pub fn new(relationship_type: CodeableConcept) -> Citation_RelatesTo1Builder {
        let mut __value: Value = json!({});
        __value["relationshipType"] = json!(relationship_type.value);
        return Citation_RelatesTo1Builder { value: __value };
    }

    pub fn _target_uri<'a>(&'a mut self, val: Element) -> &'a mut Citation_RelatesTo1Builder {
        self.value["_targetUri"] = json!(val.value);
        return self;
    }

    pub fn extension<'a>(&'a mut self, val: Vec<Extension>) -> &'a mut Citation_RelatesTo1Builder {
        self.value["extension"] = json!(val.into_iter().map(|e| e.value).collect::<Vec<_>>());
        return self;
    }

    pub fn id<'a>(&'a mut self, val: &str) -> &'a mut Citation_RelatesTo1Builder {
    ...
    pub fn modifier_extension<'a>(
        &'a mut self,
        val: Vec<Extension>,
    ) -> &'a mut Citation_RelatesTo1Builder {
    ...
    pub fn target_uri<'a>(&'a mut self, val: &str) -> &'a mut Citation_RelatesTo1Builder {
