...
use crate::models::r4b::Claim_Accident::Claim_Accident;
use crate::models::r4b::Claim_CareTeam::Claim_CareTeam;
use crate::models::r4b::Claim_Diagnosis::Claim_Diagnosis;
use crate::models::r4b::Claim_Insurance::Claim_Insurance;
use crate::models::r4b::Claim_Item::Claim_Item;
use crate::models::r4b::Claim_Payee::Claim_Payee;
use crate::models::r4b::Claim_Procedure::Claim_Procedure;
use crate::models::r4b::Claim_Related::Claim_Related;
use crate::models::r4b::Claim_SupportingInfo::Claim_SupportingInfo;
...
impl ClaimBuilder {
    ...
    pub fn fhir_use<'a>(&'a mut self, val: &str) -> &'a mut ClaimBuilder {
