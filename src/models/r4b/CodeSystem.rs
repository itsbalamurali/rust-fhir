...
use crate::models::r4b::CodeSystem_Concept::CodeSystem_Concept;
use crate::models::r4b::CodeSystem_Filter::CodeSystem_Filter;
use crate::models::r4b::CodeSystem_Property::CodeSystem_Property;
...
impl CodeSystem<'_> {
    ...
    /// The total number of concepts defined by the code system. Where the code system has
    /// a compositional grammar, the basis of this count is defined by the system steward.
    ...
    pub fn hierarchy_meaning(&self) -> Option<&str> {
        if let Some(Value::String(string)) = self.value.get("hierarchyMeaning") {
            return Some(string);
        }
        return None;
    }
...
impl CodeSystemBuilder {
    ...
    pub fn content<'a>(&'a mut self, val: &str) -> &'a mut CodeSystemBuilder {
    ...
    pub fn hierarchy_meaning<'a>(&'a mut self, val: &str) -> &'a mut CodeSystemBuilder {
        self.value["hierarchyMeaning"] = json!(val);
        return self;
    }
    ...
    pub fn status<'a>(&'a mut self, val: &str) -> &'a mut CodeSystemBuilder {
