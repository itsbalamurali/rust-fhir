...
use crate::models::r4b::CodeSystem_Designation::CodeSystem_Designation;
use crate::models::r4b::CodeSystem_Property1::CodeSystem_Property1;
...
impl CodeSystem_Concept<'_> {
    ...
    /// formal definitions required, because of the prevalence of legacy systems. However,
    /// they are highly recommended, as without them there is no formal meaning associated
    /// with the concept.
