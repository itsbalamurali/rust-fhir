...
use crate::models::r4b::Condition_Evidence::Condition_Evidence;
use crate::models::r4b::Condition_Stage::Condition_Stage;
...
impl Condition<'_> {
    ...
    /// with "remission" or "resolution" - Conditions are never really resolved, but they
    /// can abate.
