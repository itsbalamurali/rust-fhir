...
use crate::models::r4b::Consent_Policy::Consent_Policy;
use crate::models::r4b::Consent_Provision::Consent_Provision;
use crate::models::r4b::Consent_Verification::Consent_Verification;
...
impl Consent<'_> {
    ...
    /// listed in a Consent Directive or the Grantee, which is the entity responsible for
    ...
    /// original paper form, or a reference to a consent that links back to such a source,
    /// a reference to a document repository (e.g. XDS) that stores the original consent
    /// document.
