...
use crate::models::r4b::Contract_ContentDefinition::Contract_ContentDefinition;
use crate::models::r4b::Contract_Friendly::Contract_Friendly;
use crate::models::r4b::Contract_Legal::Contract_Legal;
use crate::models::r4b::Contract_Rule::Contract_Rule;
use crate::models::r4b::Contract_Signer::Contract_Signer;
use crate::models::r4b::Contract_Term::Contract_Term;
...
impl Contract<'_> {
    ...
    /// Alternative representation of the title for this Contract definition, derivative,
    /// or instance in any legal state., e.g., a domain specific contract number related
    /// to legislation.
    ...
    /// The individual or organization that authored the Contract definition, derivative,
    ...
    /// or jurisdictions formed for the purpose of achieving some form of collective
    /// action such as the promulgation, administration and enforcement of contracts and
    /// policies.
    ...
    /// The minimal content derived from the basal information source at a specific stage
    /// in its lifecycle.
    ...
    /// Provisions in a manner that is readily accessible and understandable by a
    /// layperson in accordance with best practices for communication styles that ensure
    /// that those agreeing to or signing the Contract understand the roles, actions,
    ...
    /// written document that can be formally attributed to its author, records and
    /// formally expresses a legally enforceable act, process, or contractual duty,
    ...
    /// likely to be relevant to a user looking at the current version of the Contract.
    /// The Provence.entity indicates the target that was changed in the update. http://
    /// build.fhir.org/provenance-definitions.html#Provenance.entity.
