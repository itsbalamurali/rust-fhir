...
use crate::models::r4b::CoverageEligibilityRequest_Insurance::CoverageEligibilityRequest_Insurance;
use crate::models::r4b::CoverageEligibilityRequest_Item::CoverageEligibilityRequest_Item;
use crate::models::r4b::CoverageEligibilityRequest_SupportingInfo::CoverageEligibilityRequest_SupportingInfo;
...
impl CoverageEligibilityRequest<'_> {
    ...
    /// not specified.
    pub fn purpose(&self) -> Option<Vec<&str>> {
...
impl CoverageEligibilityRequestBuilder {
    ...
    pub fn purpose<'a>(&'a mut self, val: Vec<&str>) -> &'a mut CoverageEligibilityRequestBuilder {
