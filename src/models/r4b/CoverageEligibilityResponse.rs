...
use crate::models::r4b::CoverageEligibilityResponse_Error::CoverageEligibilityResponse_Error;
use crate::models::r4b::CoverageEligibilityResponse_Insurance::CoverageEligibilityResponse_Insurance;
...
impl CoverageEligibilityResponseBuilder {
    ...
    pub fn outcome<'a>(&'a mut self, val: &str) -> &'a mut CoverageEligibilityResponseBuilder {
    ...
    pub fn purpose<'a>(&'a mut self, val: Vec<&str>) -> &'a mut CoverageEligibilityResponseBuilder {
