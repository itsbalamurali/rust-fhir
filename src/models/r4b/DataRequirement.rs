...
use crate::models::r4b::DataRequirement_CodeFilter::DataRequirement_CodeFilter;
use crate::models::r4b::DataRequirement_DateFilter::DataRequirement_DateFilter;
use crate::models::r4b::DataRequirement_Sort::DataRequirement_Sort;
...
impl DataRequirement<'_> {
    ...
    /// set of interest for a particular element of the data. Each code filter defines an
