...
use crate::models::r4b::DetectedIssue_Evidence::DetectedIssue_Evidence;
use crate::models::r4b::DetectedIssue_Mitigation::DetectedIssue_Mitigation;
...
impl DetectedIssue<'_> {
    ...
    /// the likelihood of the risk identified by the detected issue from manifesting.  Can
    /// also reflect an observation of known mitigating factors that may reduce/eliminate
...
impl DetectedIssueBuilder {
    ...
    pub fn severity<'a>(&'a mut self, val: &str) -> &'a mut DetectedIssueBuilder {
