...
use crate::models::r4b::ElementDefinition_Discriminator::ElementDefinition_Discriminator;
...
impl ElementDefinition_Slicing<'_> {
    ...
    /// the element in the resource matches based on the allowed values for those elements
