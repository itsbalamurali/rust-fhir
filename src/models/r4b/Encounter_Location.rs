...
impl Encounter_Location<'_> {
    ...
    /// period specified. If the participant is no longer at the location, then the period
    /// will have an end date/time.
...
impl Encounter_LocationBuilder {
    ...
    pub fn status<'a>(&'a mut self, val: &str) -> &'a mut Encounter_LocationBuilder {
