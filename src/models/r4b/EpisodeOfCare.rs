...
use crate::models::r4b::EpisodeOfCare_Diagnosis::EpisodeOfCare_Diagnosis;
use crate::models::r4b::EpisodeOfCare_StatusHistory::EpisodeOfCare_StatusHistory;
...
impl EpisodeOfCareBuilder {
    ...
    pub fn status<'a>(&'a mut self, val: &str) -> &'a mut EpisodeOfCareBuilder {
