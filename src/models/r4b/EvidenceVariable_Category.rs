...
#[derive(Debug)]
pub struct EvidenceVariable_Category<'a> {
    pub(crate) value: Cow<'a, Value>,
}

impl EvidenceVariable_Category<'_> {
    pub fn new(value: &Value) -> EvidenceVariable_Category {
...
#[derive(Debug)]
pub struct EvidenceVariable_CategoryBuilder {
    pub(crate) value: Value,
}

impl EvidenceVariable_CategoryBuilder {
    pub fn build(&self) -> EvidenceVariable_Category {
        EvidenceVariable_Category {
            value: Cow::Owned(self.value.clone()),
        }
    }

    pub fn with(existing: EvidenceVariable_Category) -> EvidenceVariable_CategoryBuilder {
        EvidenceVariable_CategoryBuilder {
            value: (*existing.value).clone(),
        }
    }

    pub fn new() -> EvidenceVariable_CategoryBuilder {
        let mut __value: Value = json!({});
        return EvidenceVariable_CategoryBuilder { value: __value };
    }

    pub fn _name<'a>(&'a mut self, val: Element) -> &'a mut EvidenceVariable_CategoryBuilder {
    ...
    pub fn extension<'a>(
        &'a mut self,
        val: Vec<Extension>,
    ) -> &'a mut EvidenceVariable_CategoryBuilder {
        self.value["extension"] = json!(val.into_iter().map(|e| e.value).collect::<Vec<_>>());
        return self;
    }

    pub fn id<'a>(&'a mut self, val: &str) -> &'a mut EvidenceVariable_CategoryBuilder {
    ...
    pub fn name<'a>(&'a mut self, val: &str) -> &'a mut EvidenceVariable_CategoryBuilder {
    ...
    pub fn value_range<'a>(&'a mut self, val: Range) -> &'a mut EvidenceVariable_CategoryBuilder {
