...
use crate::models::r4b::ExampleScenario_ContainedInstance::ExampleScenario_ContainedInstance;
use crate::models::r4b::ExampleScenario_Version::ExampleScenario_Version;
