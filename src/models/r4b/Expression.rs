...
impl ExpressionLanguage {
    pub fn from_string(string: &str) -> Option<ExpressionLanguage> {
        match string {
            ...
            "text/cql-identifier" => Some(ExpressionLanguage::TextCqlIdentifier),
            "text/cql-expression" => Some(ExpressionLanguage::TextCqlExpression),
            _ => None,
        }
    }
    ...
    pub fn to_string(&self) -> String {
        match self {
            ...
            ExpressionLanguage::TextCqlIdentifier => "text/cql-identifier".to_string(),
            ExpressionLanguage::TextCqlExpression => "text/cql-expression".to_string(),
        }
    }
}
