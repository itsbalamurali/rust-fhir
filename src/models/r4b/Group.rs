...
use crate::models::r4b::Group_Characteristic::Group_Characteristic;
use crate::models::r4b::Group_Member::Group_Member;
...
impl GroupBuilder {
    ...
    pub fn fhir_type<'a>(&'a mut self, val: &str) -> &'a mut GroupBuilder {
