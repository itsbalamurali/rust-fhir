...
impl Ingredient_Strength<'_> {
    ...
    /// of the single pharmaceutical product or manufactured item. Unit of presentation
    /// refers to the quantity that the item occurs in e.g. a strength per tablet size,
    /// perhaps 'per 20mg' (the size of the tablet). It is not generally normalized as a
    ...
    /// closely related substance (e.g. salt vs. base). Reference strength represents the
    /// strength (quantitative composition) of the active moiety of the active substance.
    /// There are situations when the active substance and active moiety are different,
