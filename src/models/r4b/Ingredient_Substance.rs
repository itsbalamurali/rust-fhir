...
use crate::models::r4b::Ingredient_Strength::Ingredient_Strength;
use serde_json::json;
...
impl Ingredient_Substance<'_> {
    ...
    /// of the single pharmaceutical product or manufactured item. The allowed repetitions
    /// do not represent different strengths, but are different representations -
