...
use crate::models::r4b::InsurancePlan_Contact::InsurancePlan_Contact;
use crate::models::r4b::InsurancePlan_Coverage::InsurancePlan_Coverage;
use crate::models::r4b::InsurancePlan_Plan::InsurancePlan_Plan;
...
impl InsurancePlanBuilder {
    ...
    pub fn status<'a>(&'a mut self, val: &str) -> &'a mut InsurancePlanBuilder {
