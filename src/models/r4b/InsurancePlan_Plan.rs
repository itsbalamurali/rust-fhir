...
use crate::models::r4b::InsurancePlan_GeneralCost::InsurancePlan_GeneralCost;
use crate::models::r4b::InsurancePlan_SpecificCost::InsurancePlan_SpecificCost;
...
impl InsurancePlan_Plan<'_> {
    ...
    /// Business identifiers assigned to this health insurance plan which remain constant
