...
use crate::models::r4b::Invoice_LineItem::Invoice_LineItem;
use crate::models::r4b::Invoice_Participant::Invoice_Participant;
use crate::models::r4b::Invoice_PriceComponent::Invoice_PriceComponent;
...
impl InvoiceBuilder {
    ...
    pub fn status<'a>(&'a mut self, val: &str) -> &'a mut InvoiceBuilder {
