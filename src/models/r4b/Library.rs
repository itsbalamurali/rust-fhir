...
/// definitions. It can be used to describe and expose existing knowledge assets such
/// as logic libraries and information model descriptions, as well as to describe a
...
impl Library<'_> {
    ...
    /// url, or may be directly embedded as a base-64 string. Either way, the contentType
    /// of the attachment determines how to interpret the content.
    ...
    /// changes. In addition, it should change when the substantive content of the library
    /// changes.
    ...
    /// e.g. CMS or NQF identifiers for a measure artifact. Note that at least one
    ...
    /// an authoritative instance of this library is (or will be) published. This URL can
    /// be the target of a canonical reference. It SHALL remain the same when the library
...
impl LibraryBuilder {
    ...
    pub fn status<'a>(&'a mut self, val: &str) -> &'a mut LibraryBuilder {
