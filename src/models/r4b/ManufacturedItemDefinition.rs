...
use crate::models::r4b::ManufacturedItemDefinition_Property::ManufacturedItemDefinition_Property;
...
#[derive(Debug)]
pub struct ManufacturedItemDefinition<'a> {
    pub(crate) value: Cow<'a, Value>,
}

impl ManufacturedItemDefinition<'_> {
    pub fn new(value: &Value) -> ManufacturedItemDefinition {
    ...
    /// The ingredients of this manufactured item. This is only needed if the ingredients
    ...
    pub fn property(&self) -> Option<Vec<ManufacturedItemDefinition_Property>> {
        if let Some(Value::Array(val)) = self.value.get("property") {
            return Some(
                val.into_iter()
                    .map(|e| ManufacturedItemDefinition_Property {
                        value: Cow::Borrowed(e),
                    })
                    .collect::<Vec<_>>(),
            );
...
#[derive(Debug)]
pub struct ManufacturedItemDefinitionBuilder {
    pub(crate) value: Value,
}

impl ManufacturedItemDefinitionBuilder {
    pub fn build(&self) -> ManufacturedItemDefinition {
        ManufacturedItemDefinition {
            value: Cow::Owned(self.value.clone()),
        }
    }

    pub fn with(existing: ManufacturedItemDefinition) -> ManufacturedItemDefinitionBuilder {
        ManufacturedItemDefinitionBuilder {
            value: (*existing.value).clone(),
        }
    }

    pub fn new(manufactured_dose_form: CodeableConcept) -> ManufacturedItemDefinitionBuilder {
        let mut __value: Value = json!({});
        __value["manufacturedDoseForm"] = json!(manufactured_dose_form.value);
        return ManufacturedItemDefinitionBuilder { value: __value };
    }

    pub fn _implicit_rules<'a>(
        &'a mut self,
        val: Element,
    ) -> &'a mut ManufacturedItemDefinitionBuilder {
        self.value["_implicitRules"] = json!(val.value);
        return self;
    }

    pub fn _language<'a>(&'a mut self, val: Element) -> &'a mut ManufacturedItemDefinitionBuilder {
        self.value["_language"] = json!(val.value);
        return self;
    }

    pub fn _status<'a>(&'a mut self, val: Element) -> &'a mut ManufacturedItemDefinitionBuilder {
    ...
    pub fn id<'a>(&'a mut self, val: &str) -> &'a mut ManufacturedItemDefinitionBuilder {
    ...
    pub fn language<'a>(&'a mut self, val: &str) -> &'a mut ManufacturedItemDefinitionBuilder {
    ...
    pub fn meta<'a>(&'a mut self, val: Meta) -> &'a mut ManufacturedItemDefinitionBuilder {
    ...
    pub fn property<'a>(
        &'a mut self,
        val: Vec<ManufacturedItemDefinition_Property>,
    ) -> &'a mut ManufacturedItemDefinitionBuilder {
        self.value["property"] = json!(val.into_iter().map(|e| e.value).collect::<Vec<_>>());
        return self;
    }

    pub fn status<'a>(&'a mut self, val: &str) -> &'a mut ManufacturedItemDefinitionBuilder {
        self.value["status"] = json!(val);
        return self;
    }

    pub fn text<'a>(&'a mut self, val: Narrative) -> &'a mut ManufacturedItemDefinitionBuilder {
