...
use crate::models::r4b::Medication_Batch::Medication_Batch;
use crate::models::r4b::Medication_Ingredient::Medication_Ingredient;
...
impl Medication<'_> {
    ...
    /// if no code is available. Usage note: This could be a standard medication code such
    /// as a code from RxNorm, SNOMED CT, IDMP etc. It could also be a national or local
