...
use crate::models::r4b::MedicationKnowledge_AdministrationGuidelines::MedicationKnowledge_AdministrationGuidelines;
use crate::models::r4b::MedicationKnowledge_Cost::MedicationKnowledge_Cost;
use crate::models::r4b::MedicationKnowledge_DrugCharacteristic::MedicationKnowledge_DrugCharacteristic;
use crate::models::r4b::MedicationKnowledge_Ingredient::MedicationKnowledge_Ingredient;
use crate::models::r4b::MedicationKnowledge_Kinetics::MedicationKnowledge_Kinetics;
use crate::models::r4b::MedicationKnowledge_MedicineClassification::MedicationKnowledge_MedicineClassification;
use crate::models::r4b::MedicationKnowledge_MonitoringProgram::MedicationKnowledge_MonitoringProgram;
use crate::models::r4b::MedicationKnowledge_Monograph::MedicationKnowledge_Monograph;
use crate::models::r4b::MedicationKnowledge_Packaging::MedicationKnowledge_Packaging;
use crate::models::r4b::MedicationKnowledge_Regulatory::MedicationKnowledge_Regulatory;
use crate::models::r4b::MedicationKnowledge_RelatedMedicationKnowledge::MedicationKnowledge_RelatedMedicationKnowledge;
...
impl MedicationKnowledge<'_> {
    ...
    /// Specific amount of the drug in the packaged product.  For example, when specifying
    /// a product that has the same strength (For example, Insulin glargine 100 unit per
    /// mL solution for injection), this attribute provides additional clarification of
    ...
    /// Additional names for a medication, for example, the name(s) given to a medication
