...
use crate::models::r4b::MedicinalProductDefinition_Characteristic::MedicinalProductDefinition_Characteristic;
use crate::models::r4b::MedicinalProductDefinition_Contact::MedicinalProductDefinition_Contact;
use crate::models::r4b::MedicinalProductDefinition_CrossReference::MedicinalProductDefinition_CrossReference;
use crate::models::r4b::MedicinalProductDefinition_Name::MedicinalProductDefinition_Name;
use crate::models::r4b::MedicinalProductDefinition_Operation::MedicinalProductDefinition_Operation;
...
impl MedicinalProductDefinition<'_> {
    ...
    /// compared to a product instance being prescribed, is actually a product type). See
    /// also MedicinalProductDefinition.code.
    ...
    /// This refers to the product being actually 'on the market' as opposed to being
    /// allowed to be on the market (which is an authorization).
