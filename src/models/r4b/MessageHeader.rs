...
use crate::models::r4b::MessageHeader_Destination::MessageHeader_Destination;
use crate::models::r4b::MessageHeader_Response::MessageHeader_Response;
use crate::models::r4b::MessageHeader_Source::MessageHeader_Source;
...
impl MessageHeader<'_> {
    ...
    /// "http://terminology.hl7.org/CodeSystem/message-events".  Alternatively uri to
    /// the EventDefinition.
