...
use crate::models::r4b::MolecularSequence_Quality::MolecularSequence_Quality;
use crate::models::r4b::MolecularSequence_ReferenceSeq::MolecularSequence_ReferenceSeq;
use crate::models::r4b::MolecularSequence_Repository::MolecularSequence_Repository;
use crate::models::r4b::MolecularSequence_StructureVariant::MolecularSequence_StructureVariant;
use crate::models::r4b::MolecularSequence_Variant::MolecularSequence_Variant;
...
impl MolecularSequence<'_> {
    ...
    /// A unique identifier for this particular sequence instance. This is a FHIR-defined
    /// id.
    ...
    /// in a quantitative way, such as a phred quality score ([SO:0001686](http://
...
impl MolecularSequenceBuilder {
    ...
    pub fn fhir_type<'a>(&'a mut self, val: &str) -> &'a mut MolecularSequenceBuilder {
