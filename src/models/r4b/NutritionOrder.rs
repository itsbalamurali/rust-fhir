...
use crate::models::r4b::NutritionOrder_EnteralFormula::NutritionOrder_EnteralFormula;
use crate::models::r4b::NutritionOrder_OralDiet::NutritionOrder_OralDiet;
use crate::models::r4b::NutritionOrder_Supplement::NutritionOrder_Supplement;
...
impl NutritionOrder<'_> {
    ...
    /// or preferences such as Halal, Vegan or Kosher. This modifier applies to the entire
