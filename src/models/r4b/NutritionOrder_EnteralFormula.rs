...
use crate::models::r4b::NutritionOrder_Administration::NutritionOrder_Administration;
...
impl NutritionOrder_EnteralFormula<'_> {
    ...
    /// continuous feeding.  An example of this would be an instruction to increase the
    ...
    /// Free text formula administration, feeding instructions or additional instructions
    /// or information.
