...
use crate::models::r4b::Observation_Component::Observation_Component;
use crate::models::r4b::Observation_ReferenceRange::Observation_ReferenceRange;
...
impl Observation<'_> {
    ...
    /// subject), the `focus` element or the `code` itself specifies the actual focus of
    /// the observation.
