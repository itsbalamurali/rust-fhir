...
use crate::models::r4b::OperationDefinition_Binding::OperationDefinition_Binding;
use crate::models::r4b::OperationDefinition_ReferencedFrom::OperationDefinition_ReferencedFrom;
use serde_json::json;
...
impl OperationDefinition_Parameter<'_> {
    ...
    pub fn search_type(&self) -> Option<&str> {
        if let Some(Value::String(string)) = self.value.get("searchType") {
            return Some(string);
        }
        return None;
    }
...
impl OperationDefinition_ParameterBuilder {
    ...
    pub fn search_type<'a>(
        ...
        self.value["searchType"] = json!(val);
        return self;
    }
    ...
    pub fn fhir_use<'a>(&'a mut self, val: &str) -> &'a mut OperationDefinition_ParameterBuilder {
