...
impl PackagedProductDefinition<'_> {
    ...
    /// allow different counts of similar items (e.g. not '2 tubes and 3 tubes'). Repeats
    /// are not to be used to represent different pack sizes (e.g. 20 pack vs. 50 pack) -
