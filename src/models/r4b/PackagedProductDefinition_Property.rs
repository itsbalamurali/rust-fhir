...
#[derive(Debug)]
pub struct PackagedProductDefinition_Property<'a> {
    pub(crate) value: Cow<'a, Value>,
}

impl PackagedProductDefinition_Property<'_> {
    pub fn new(value: &Value) -> PackagedProductDefinition_Property {
...
#[derive(Debug)]
pub struct PackagedProductDefinition_PropertyBuilder {
    pub(crate) value: Value,
}

impl PackagedProductDefinition_PropertyBuilder {
    pub fn build(&self) -> PackagedProductDefinition_Property {
        PackagedProductDefinition_Property {
    ...
    pub fn with(
        existing: PackagedProductDefinition_Property,
    ) -> PackagedProductDefinition_PropertyBuilder {
        PackagedProductDefinition_PropertyBuilder {
            value: (*existing.value).clone(),
        }
    }

    pub fn new(fhir_type: CodeableConcept) -> PackagedProductDefinition_PropertyBuilder {
        let mut __value: Value = json!({});
        __value["type"] = json!(fhir_type.value);
        return PackagedProductDefinition_PropertyBuilder { value: __value };
    }

    pub fn _value_boolean<'a>(
        &'a mut self,
        val: Element,
    ) -> &'a mut PackagedProductDefinition_PropertyBuilder {
    ...
    pub fn id<'a>(&'a mut self, val: &str) -> &'a mut PackagedProductDefinition_PropertyBuilder {
