...
use crate::models::r4b::PaymentReconciliation_Detail::PaymentReconciliation_Detail;
use crate::models::r4b::PaymentReconciliation_ProcessNote::PaymentReconciliation_ProcessNote;
...
impl PaymentReconciliationBuilder {
    ...
    pub fn outcome<'a>(&'a mut self, val: &str) -> &'a mut PaymentReconciliationBuilder {
