...
use crate::models::r4b::PractitionerRole_AvailableTime::PractitionerRole_AvailableTime;
use crate::models::r4b::PractitionerRole_NotAvailable::PractitionerRole_NotAvailable;
