...
impl ProdCharacteristic<'_> {
    ...
    /// Where applicable, the depth can be specified using a numerical value and its unit
    /// of measurement The unit of measurement shall be specified in accordance with ISO
    /// 11240 and the resulting terminology The symbol and the symbol identifier shall
    /// be used.
    ...
    /// Where applicable, the width can be specified using a numerical value and its unit
    /// of measurement The unit of measurement shall be specified in accordance with ISO
    /// 11240 and the resulting terminology The symbol and the symbol identifier shall
    /// be used.
