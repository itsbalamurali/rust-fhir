...
use crate::models::r4b::Questionnaire_AnswerOption::Questionnaire_AnswerOption;
use crate::models::r4b::Questionnaire_EnableWhen::Questionnaire_EnableWhen;
use crate::models::r4b::Questionnaire_Initial::Questionnaire_Initial;
use serde_json::json;
...
impl Questionnaire_Item<'_> {
    ...
    /// Comments, below. If this element is present then the following element values
    /// MAY be derived from the Element Definition if the corresponding elements of this
    /// Questionnaire resource instance have no value:    * code (ElementDefinition.code)
    /// * type (ElementDefinition.type)   * required (ElementDefinition.min)   *
    /// repeats (ElementDefinition.max)   * maxLength (ElementDefinition.maxLength)   *
