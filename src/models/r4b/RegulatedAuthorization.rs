...
use crate::models::r4b::RegulatedAuthorization_Case::RegulatedAuthorization_Case;
...
impl RegulatedAuthorization<'_> {
    ...
    /// authorization. An authorization is granted in response to submissions/applications
    /// by those seeking authorization. A case is the administrative process that deals
    /// with the application(s) that relate to this and assesses them. Note: This area is
    /// subject to ongoing review and the workgroup is seeking implementer feedback on its
