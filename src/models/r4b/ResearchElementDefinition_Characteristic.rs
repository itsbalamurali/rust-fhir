...
impl ResearchElementDefinition_Characteristic<'_> {
    ...
    pub fn participant_effective_group_measure(&self) -> Option<&str> {
        if let Some(Value::String(string)) = self.value.get("participantEffectiveGroupMeasure") {
            return Some(string);
        }
        return None;
    }
    ...
    /// Indicates how elements are aggregated within the study effective period.
    pub fn study_effective_group_measure(&self) -> Option<&str> {
        if let Some(Value::String(string)) = self.value.get("studyEffectiveGroupMeasure") {
            return Some(string);
        }
        return None;
    }
...
impl ResearchElementDefinition_CharacteristicBuilder {
    ...
    pub fn participant_effective_group_measure<'a>(
        ...
        self.value["participantEffectiveGroupMeasure"] = json!(val);
        return self;
    }
    ...
    pub fn study_effective_group_measure<'a>(
        ...
        self.value["studyEffectiveGroupMeasure"] = json!(val);
        return self;
    }
