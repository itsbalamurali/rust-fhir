...
use crate::models::r4b::Specimen_Collection::Specimen_Collection;
use crate::models::r4b::Specimen_Container::Specimen_Container;
use crate::models::r4b::Specimen_Processing::Specimen_Processing;
use serde_json::json;
...
impl SpecimenBuilder {
    ...
    pub fn status<'a>(&'a mut self, val: &str) -> &'a mut SpecimenBuilder {
