...
use crate::models::r4b::StructureMap_Group::StructureMap_Group;
use crate::models::r4b::StructureMap_Structure::StructureMap_Structure;
...
impl StructureMap<'_> {
    ...
    /// A natural language name identifying the structure map. This name should be usable
    ...
    /// An absolute URI that is used to identify this structure map when it is referenced
    /// in a specification, model, design or an instance; also called its canonical
    /// identifier. This SHOULD be globally unique and SHOULD be a literal address at
    /// which at which an authoritative instance of this structure map is (or will be)
    ...
    /// The identifier that is used to identify this version of the structure map when it
    /// is referenced in a specification, model, design or instance. This is an arbitrary
    /// value managed by the structure map author and is not expected to be globally
...
impl StructureMapBuilder {
    ...
    pub fn status<'a>(&'a mut self, val: &str) -> &'a mut StructureMapBuilder {
