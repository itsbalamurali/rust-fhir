...
impl SubscriptionTopic_CanFilterBy<'_> {
    ...
    pub fn _filter_definition(&self) -> Option<Element> {
        if let Some(val) = self.value.get("_filterDefinition") {
            return Some(Element {
                value: Cow::Borrowed(val),
            });
        }
    ...
    pub fn filter_definition(&self) -> Option<&str> {
        if let Some(Value::String(string)) = self.value.get("filterDefinition") {
            return Some(string);
        }
        return None;
    }
    ...
    pub fn validate(&self) -> bool {
        ...
        if let Some(_val) = self._filter_definition() {
            if !_val.validate() {
                return false;
            }
        }
        ...
        if let Some(_val) = self.filter_definition() {}
...
impl SubscriptionTopic_CanFilterByBuilder {
    ...
    pub fn _filter_definition<'a>(
        &'a mut self,
        val: Element,
    ) -> &'a mut SubscriptionTopic_CanFilterByBuilder {
        self.value["_filterDefinition"] = json!(val.value);
        return self;
    }
    ...
    pub fn filter_definition<'a>(
        &'a mut self,
        val: &str,
    ) -> &'a mut SubscriptionTopic_CanFilterByBuilder {
        self.value["filterDefinition"] = json!(val);
        return self;
    }
