...
impl SubscriptionTopic_QueryCriteria<'_> {
    ...
    /// The FHIR query based rules are applied to the current resource state (e.g., state
    /// after an update).
    ...
    /// The FHIR query based rules are applied to the previous resource state (e.g., state
    /// before an update).
