...
use crate::models::r4b::Substance_Ingredient::Substance_Ingredient;
use crate::models::r4b::Substance_Instance::Substance_Instance;
use serde_json::json;
...
impl Substance<'_> {
    ...
    /// Substance may be used to describe a kind of substance, or a specific package/
    /// container of the substance: an instance.
