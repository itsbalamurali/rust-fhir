...
#[derive(Debug)]
pub struct SubstanceDefinition_Moiety<'a> {
    pub(crate) value: Cow<'a, Value>,
}

impl SubstanceDefinition_Moiety<'_> {
    pub fn new(value: &Value) -> SubstanceDefinition_Moiety {
    ...
    pub fn measurement_type(&self) -> Option<CodeableConcept> {
        if let Some(val) = self.value.get("measurementType") {
    ...
    pub fn validate(&self) -> bool {
        ...
        if let Some(_val) = self.measurement_type() {
            if !_val.validate() {
                return false;
            }
        }
...
#[derive(Debug)]
pub struct SubstanceDefinition_MoietyBuilder {
    pub(crate) value: Value,
}

impl SubstanceDefinition_MoietyBuilder {
    pub fn build(&self) -> SubstanceDefinition_Moiety {
        SubstanceDefinition_Moiety {
            value: Cow::Owned(self.value.clone()),
        }
    }

    pub fn with(existing: SubstanceDefinition_Moiety) -> SubstanceDefinition_MoietyBuilder {
        SubstanceDefinition_MoietyBuilder {
            value: (*existing.value).clone(),
        }
    }

    pub fn new() -> SubstanceDefinition_MoietyBuilder {
        let mut __value: Value = json!({});
        return SubstanceDefinition_MoietyBuilder { value: __value };
    }

    pub fn _amount_string<'a>(
        &'a mut self,
        val: Element,
    ) -> &'a mut SubstanceDefinition_MoietyBuilder {
    ...
    pub fn _name<'a>(&'a mut self, val: Element) -> &'a mut SubstanceDefinition_MoietyBuilder {
    ...
    pub fn amount_string<'a>(&'a mut self, val: &str) -> &'a mut SubstanceDefinition_MoietyBuilder {
    ...
    pub fn id<'a>(&'a mut self, val: &str) -> &'a mut SubstanceDefinition_MoietyBuilder {
    ...
    pub fn measurement_type<'a>(
        &'a mut self,
        val: CodeableConcept,
    ) -> &'a mut SubstanceDefinition_MoietyBuilder {
        self.value["measurementType"] = json!(val.value);
        return self;
    }
    ...
    pub fn name<'a>(&'a mut self, val: &str) -> &'a mut SubstanceDefinition_MoietyBuilder {
