...
use crate::models::r4b::SubstanceDefinition_Official::SubstanceDefinition_Official;
use serde_json::json;
...
#[derive(Debug)]
pub struct SubstanceDefinition_Name<'a> {
    pub(crate) value: Cow<'a, Value>,
}

impl SubstanceDefinition_Name<'_> {
    pub fn new(value: &Value) -> SubstanceDefinition_Name {
    ...
    pub fn official(&self) -> Option<Vec<SubstanceDefinition_Official>> {
        if let Some(Value::Array(val)) = self.value.get("official") {
            return Some(
                val.into_iter()
                    .map(|e| SubstanceDefinition_Official {
                        value: Cow::Borrowed(e),
                    })
                    .collect::<Vec<_>>(),
            );
    ...
    pub fn synonym(&self) -> Option<Vec<SubstanceDefinition_Name>> {
    ...
    pub fn translation(&self) -> Option<Vec<SubstanceDefinition_Name>> {
...
#[derive(Debug)]
pub struct SubstanceDefinition_NameBuilder {
    pub(crate) value: Value,
}

impl SubstanceDefinition_NameBuilder {
    pub fn build(&self) -> SubstanceDefinition_Name {
        SubstanceDefinition_Name {
            value: Cow::Owned(self.value.clone()),
        }
    }

    pub fn with(existing: SubstanceDefinition_Name) -> SubstanceDefinition_NameBuilder {
        SubstanceDefinition_NameBuilder {
            value: (*existing.value).clone(),
        }
    }

    pub fn new() -> SubstanceDefinition_NameBuilder {
        let mut __value: Value = json!({});
        return SubstanceDefinition_NameBuilder { value: __value };
    }

    pub fn _name<'a>(&'a mut self, val: Element) -> &'a mut SubstanceDefinition_NameBuilder {
        self.value["_name"] = json!(val.value);
        return self;
    }

    pub fn _preferred<'a>(&'a mut self, val: Element) -> &'a mut SubstanceDefinition_NameBuilder {
    ...
    ) -> &'a mut SubstanceDefinition_NameBuilder {
    ...
    pub fn id<'a>(&'a mut self, val: &str) -> &'a mut SubstanceDefinition_NameBuilder {
    ...
    pub fn name<'a>(&'a mut self, val: &str) -> &'a mut SubstanceDefinition_NameBuilder {
    ...
    pub fn official<'a>(
        &'a mut self,
        val: Vec<SubstanceDefinition_Official>,
    ) -> &'a mut SubstanceDefinition_NameBuilder {
        self.value["official"] = json!(val.into_iter().map(|e| e.value).collect::<Vec<_>>());
        return self;
    }

    pub fn preferred<'a>(&'a mut self, val: bool) -> &'a mut SubstanceDefinition_NameBuilder {
