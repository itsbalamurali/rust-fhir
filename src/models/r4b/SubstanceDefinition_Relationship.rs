...
impl SubstanceDefinition_Relationship<'_> {
    ...
    pub fn comparator(&self) -> Option<CodeableConcept> {
        if let Some(val) = self.value.get("comparator") {
    ...
    pub fn ratio_high_limit_amount(&self) -> Option<Ratio> {
        if let Some(val) = self.value.get("ratioHighLimitAmount") {
            return Some(Ratio {
                value: Cow::Borrowed(val),
            });
        }
    ...
    pub fn validate(&self) -> bool {
        ...
        if let Some(_val) = self.ratio_high_limit_amount() {
            if !_val.validate() {
                return false;
            }
        }
...
impl SubstanceDefinition_RelationshipBuilder {
    ...
    pub fn comparator<'a>(
        ...
        self.value["comparator"] = json!(val.value);
        return self;
    }
    ...
    pub fn ratio_high_limit_amount<'a>(
        &'a mut self,
        val: Ratio,
    ) -> &'a mut SubstanceDefinition_RelationshipBuilder {
        self.value["ratioHighLimitAmount"] = json!(val.value);
        return self;
    }
