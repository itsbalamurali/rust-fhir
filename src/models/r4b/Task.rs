...
use crate::models::r4b::Task_Input::Task_Input;
use crate::models::r4b::Task_Output::Task_Output;
use crate::models::r4b::Task_Restriction::Task_Restriction;
use serde_json::json;
...
impl Task<'_> {
    ...
    /// is created to fulfill a procedureRequest ( = FocusOn ) to collect a specimen from
    /// a patient.
    ...
    /// is asking for the request to be actioned), this element identifies any limitations
...
impl TaskBuilder {
    ...
    pub fn intent<'a>(&'a mut self, val: &str) -> &'a mut TaskBuilder {
    ...
    pub fn status<'a>(&'a mut self, val: &str) -> &'a mut TaskBuilder {
