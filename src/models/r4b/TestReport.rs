...
use crate::models::r4b::TestReport_Participant::TestReport_Participant;
use crate::models::r4b::TestReport_Setup::TestReport_Setup;
use crate::models::r4b::TestReport_Teardown::TestReport_Teardown;
use crate::models::r4b::TestReport_Test::TestReport_Test;
use serde_json::json;
...
impl TestReport<'_> {
    ...
    pub fn result(&self) -> Option<&str> {
        if let Some(Value::String(string)) = self.value.get("result") {
            return Some(string);
        }
        return None;
    }
...
impl TestReportBuilder {
    ...
    pub fn result<'a>(&'a mut self, val: &str) -> &'a mut TestReportBuilder {
        self.value["result"] = json!(val);
        return self;
    }
    ...
    pub fn status<'a>(&'a mut self, val: &str) -> &'a mut TestReportBuilder {
