...
use crate::models::r4b::Timing_Repeat::Timing_Repeat;
use serde_json::json;
...
impl Timing<'_> {
    ...
    /// is specified in the structured timing data, and either the code or the data may be
    /// used to interpret the Timing, with the exception that .repeat.bounds still applies
