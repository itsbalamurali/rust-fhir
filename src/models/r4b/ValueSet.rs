...
use crate::models::r4b::ValueSet_Compose::ValueSet_Compose;
use crate::models::r4b::ValueSet_Expansion::ValueSet_Expansion;
use serde_json::json;
...
impl ValueSet<'_> {
    ...
    /// an authoritative instance of this value set is (or will be) published. This URL
