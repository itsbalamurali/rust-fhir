...
#[derive(Debug)]
pub struct AdministrableProductDefinition_WithdrawalPeriod<'a> {
    pub(crate) value: Cow<'a, Value>,
}

impl AdministrableProductDefinition_WithdrawalPeriod<'_> {
    pub fn new(value: &Value) -> AdministrableProductDefinition_WithdrawalPeriod {
...
#[derive(Debug)]
pub struct AdministrableProductDefinition_WithdrawalPeriodBuilder {
    pub(crate) value: Value,
}

impl AdministrableProductDefinition_WithdrawalPeriodBuilder {
    pub fn build(&self) -> AdministrableProductDefinition_WithdrawalPeriod {
        AdministrableProductDefinition_WithdrawalPeriod {
    ...
    pub fn with(
        existing: AdministrableProductDefinition_WithdrawalPeriod,
    ) -> AdministrableProductDefinition_WithdrawalPeriodBuilder {
        AdministrableProductDefinition_WithdrawalPeriodBuilder {
    ...
    pub fn new(
        ...
        return AdministrableProductDefinition_WithdrawalPeriodBuilder { value: __value };
    }

    pub fn _supporting_information<'a>(
        &'a mut self,
        val: Element,
    ) -> &'a mut AdministrableProductDefinition_WithdrawalPeriodBuilder {
