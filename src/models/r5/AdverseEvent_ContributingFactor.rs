...
#[derive(Debug)]
pub struct AdverseEvent_ContributingFactor<'a> {
    pub(crate) value: Cow<'a, Value>,
}

impl AdverseEvent_ContributingFactor<'_> {
    pub fn new(value: &Value) -> AdverseEvent_ContributingFactor {
...
#[derive(Debug)]
pub struct AdverseEvent_ContributingFactorBuilder {
    pub(crate) value: Value,
}

impl AdverseEvent_ContributingFactorBuilder {
    pub fn build(&self) -> AdverseEvent_ContributingFactor {
        AdverseEvent_ContributingFactor {
    ...
    pub fn with(
        existing: AdverseEvent_ContributingFactor,
    ) -> AdverseEvent_ContributingFactorBuilder {
        AdverseEvent_ContributingFactorBuilder {
            value: (*existing.value).clone(),
        }
    }

    pub fn new() -> AdverseEvent_ContributingFactorBuilder {
        let mut __value: Value = json!({});
        return AdverseEvent_ContributingFactorBuilder { value: __value };
    }

    pub fn extension<'a>(
        &'a mut self,
        val: Vec<Extension>,
    ) -> &'a mut AdverseEvent_ContributingFactorBuilder {
        self.value["extension"] = json!(val.into_iter().map(|e| e.value).collect::<Vec<_>>());
        return self;
    }

    pub fn id<'a>(&'a mut self, val: &str) -> &'a mut AdverseEvent_ContributingFactorBuilder {
