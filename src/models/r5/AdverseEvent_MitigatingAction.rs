...
#[derive(Debug)]
pub struct AdverseEvent_MitigatingAction<'a> {
    pub(crate) value: Cow<'a, Value>,
}

impl AdverseEvent_MitigatingAction<'_> {
    pub fn new(value: &Value) -> AdverseEvent_MitigatingAction {
...
#[derive(Debug)]
pub struct AdverseEvent_MitigatingActionBuilder {
    pub(crate) value: Value,
}

impl AdverseEvent_MitigatingActionBuilder {
    pub fn build(&self) -> AdverseEvent_MitigatingAction {
        AdverseEvent_MitigatingAction {
            value: Cow::Owned(self.value.clone()),
        }
    }

    pub fn with(existing: AdverseEvent_MitigatingAction) -> AdverseEvent_MitigatingActionBuilder {
        AdverseEvent_MitigatingActionBuilder {
            value: (*existing.value).clone(),
        }
    }

    pub fn new() -> AdverseEvent_MitigatingActionBuilder {
        let mut __value: Value = json!({});
        return AdverseEvent_MitigatingActionBuilder { value: __value };
    }

    pub fn extension<'a>(
        &'a mut self,
        val: Vec<Extension>,
    ) -> &'a mut AdverseEvent_MitigatingActionBuilder {
        self.value["extension"] = json!(val.into_iter().map(|e| e.value).collect::<Vec<_>>());
        return self;
    }

    pub fn id<'a>(&'a mut self, val: &str) -> &'a mut AdverseEvent_MitigatingActionBuilder {
