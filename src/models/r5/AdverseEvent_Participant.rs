...
#[derive(Debug)]
pub struct AdverseEvent_Participant<'a> {
    pub(crate) value: Cow<'a, Value>,
}

impl AdverseEvent_Participant<'_> {
    pub fn new(value: &Value) -> AdverseEvent_Participant {
...
#[derive(Debug)]
pub struct AdverseEvent_ParticipantBuilder {
    pub(crate) value: Value,
}

impl AdverseEvent_ParticipantBuilder {
    pub fn build(&self) -> AdverseEvent_Participant {
        AdverseEvent_Participant {
            value: Cow::Owned(self.value.clone()),
        }
    }

    pub fn with(existing: AdverseEvent_Participant) -> AdverseEvent_ParticipantBuilder {
        AdverseEvent_ParticipantBuilder {
            value: (*existing.value).clone(),
        }
    }

    pub fn new(actor: Reference) -> AdverseEvent_ParticipantBuilder {
        let mut __value: Value = json!({});
        __value["actor"] = json!(actor.value);
        return AdverseEvent_ParticipantBuilder { value: __value };
    }

    pub fn extension<'a>(
        &'a mut self,
        val: Vec<Extension>,
    ) -> &'a mut AdverseEvent_ParticipantBuilder {
    ...
    pub fn id<'a>(&'a mut self, val: &str) -> &'a mut AdverseEvent_ParticipantBuilder {
