...
#[derive(Debug)]
pub struct AdverseEvent_PreventiveAction<'a> {
    pub(crate) value: Cow<'a, Value>,
}

impl AdverseEvent_PreventiveAction<'_> {
    pub fn new(value: &Value) -> AdverseEvent_PreventiveAction {
...
#[derive(Debug)]
pub struct AdverseEvent_PreventiveActionBuilder {
    pub(crate) value: Value,
}

impl AdverseEvent_PreventiveActionBuilder {
    pub fn build(&self) -> AdverseEvent_PreventiveAction {
        AdverseEvent_PreventiveAction {
            value: Cow::Owned(self.value.clone()),
        }
    }

    pub fn with(existing: AdverseEvent_PreventiveAction) -> AdverseEvent_PreventiveActionBuilder {
        AdverseEvent_PreventiveActionBuilder {
            value: (*existing.value).clone(),
        }
    }

    pub fn new() -> AdverseEvent_PreventiveActionBuilder {
        let mut __value: Value = json!({});
        return AdverseEvent_PreventiveActionBuilder { value: __value };
    }

    pub fn extension<'a>(
        &'a mut self,
        val: Vec<Extension>,
    ) -> &'a mut AdverseEvent_PreventiveActionBuilder {
        self.value["extension"] = json!(val.into_iter().map(|e| e.value).collect::<Vec<_>>());
        return self;
    }

    pub fn id<'a>(&'a mut self, val: &str) -> &'a mut AdverseEvent_PreventiveActionBuilder {
