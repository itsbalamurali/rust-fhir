...
use crate::models::r5::AdverseEvent_Causality::AdverseEvent_Causality;
...
impl AdverseEvent_SuspectEntity<'_> {
    ...
    pub fn causality(&self) -> Option<AdverseEvent_Causality> {
        if let Some(val) = self.value.get("causality") {
            return Some(AdverseEvent_Causality {
    ...
    /// device.
    pub fn instance_codeable_concept(&self) -> Option<CodeableConcept> {
        if let Some(val) = self.value.get("instanceCodeableConcept") {
    ...
    /// substance, medication, medication administration, medication statement or a
    /// device.
    pub fn instance_reference(&self) -> Option<Reference> {
        if let Some(val) = self.value.get("instanceReference") {
    ...
    pub fn validate(&self) -> bool {
        ...
        if let Some(_val) = self.instance_codeable_concept() {
            if !_val.validate() {
                return false;
            }
        }
        if let Some(_val) = self.instance_reference() {
            if !_val.validate() {
                return false;
            }
        }
...
impl AdverseEvent_SuspectEntityBuilder {
    ...
    pub fn new() -> AdverseEvent_SuspectEntityBuilder {
    ...
    pub fn causality<'a>(
        &'a mut self,
        val: AdverseEvent_Causality,
    ) -> &'a mut AdverseEvent_SuspectEntityBuilder {
        self.value["causality"] = json!(val.value);
        return self;
    }
    ...
    pub fn instance_codeable_concept<'a>(
        &'a mut self,
        val: CodeableConcept,
    ) -> &'a mut AdverseEvent_SuspectEntityBuilder {
        self.value["instanceCodeableConcept"] = json!(val.value);
        return self;
    }

    pub fn instance_reference<'a>(
        &'a mut self,
        val: Reference,
    ) -> &'a mut AdverseEvent_SuspectEntityBuilder {
        self.value["instanceReference"] = json!(val.value);
        return self;
    }
