...
impl AllergyIntolerance_Reaction<'_> {
    ...
    /// reaction event.
    pub fn manifestation(&self) -> Vec<CodeableReference> {
        self.value
            .get("manifestation")
            .unwrap()
            .as_array()
...
impl AllergyIntolerance_ReactionBuilder {
    ...
    pub fn new(manifestation: Vec<CodeableReference>) -> AllergyIntolerance_ReactionBuilder {
    ...
    pub fn severity<'a>(&'a mut self, val: &str) -> &'a mut AllergyIntolerance_ReactionBuilder {
