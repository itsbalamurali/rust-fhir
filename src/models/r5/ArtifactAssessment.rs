...
impl ArtifactAssessment<'_> {
    ...
    /// Display of or reference to the bibliographic citation of the comment, classifier,
    /// or rating.
    ...
    /// the artifact assessment changes.
    ...
    /// An absolute URI that is used to identify this {{title}} when it is referenced in a
    ...
    /// an authoritative instance of this {{title}} is (or will be) published. This URL
