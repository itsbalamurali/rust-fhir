...
use crate::models::r5::AuditEvent_Agent::AuditEvent_Agent;
use crate::models::r5::AuditEvent_Entity::AuditEvent_Entity;
use crate::models::r5::AuditEvent_Outcome::AuditEvent_Outcome;
use crate::models::r5::AuditEvent_Source::AuditEvent_Source;
...
impl AuditEvent<'_> {
    ...
    pub fn action(&self) -> Option<&str> {
        if let Some(Value::String(string)) = self.value.get("action") {
            return Some(string);
        }
        return None;
    }
    ...
    pub fn outcome(&self) -> Option<AuditEvent_Outcome> {
        if let Some(val) = self.value.get("outcome") {
            return Some(AuditEvent_Outcome {
                value: Cow::Borrowed(val),
            });
        }
        return None;
...
impl AuditEventBuilder {
    ...
    pub fn _occurred_date_time<'a>(&'a mut self, val: Element) -> &'a mut AuditEventBuilder {
    ...
    pub fn _severity<'a>(&'a mut self, val: Element) -> &'a mut AuditEventBuilder {
        self.value["_severity"] = json!(val.value);
        return self;
    }

    pub fn action<'a>(&'a mut self, val: &str) -> &'a mut AuditEventBuilder {
        self.value["action"] = json!(val);
        return self;
    }

    pub fn authorization<'a>(&'a mut self, val: Vec<CodeableConcept>) -> &'a mut AuditEventBuilder {
        self.value["authorization"] = json!(val.into_iter().map(|e| e.value).collect::<Vec<_>>());
        return self;
    }

    pub fn based_on<'a>(&'a mut self, val: Vec<Reference>) -> &'a mut AuditEventBuilder {
        self.value["basedOn"] = json!(val.into_iter().map(|e| e.value).collect::<Vec<_>>());
        return self;
    }

    pub fn category<'a>(&'a mut self, val: Vec<CodeableConcept>) -> &'a mut AuditEventBuilder {
    ...
    pub fn encounter<'a>(&'a mut self, val: Reference) -> &'a mut AuditEventBuilder {
    ...
    pub fn occurred_date_time<'a>(&'a mut self, val: &str) -> &'a mut AuditEventBuilder {
        self.value["occurredDateTime"] = json!(val);
        return self;
    }

    pub fn occurred_period<'a>(&'a mut self, val: Period) -> &'a mut AuditEventBuilder {
        self.value["occurredPeriod"] = json!(val.value);
        return self;
    }

    pub fn outcome<'a>(&'a mut self, val: AuditEvent_Outcome) -> &'a mut AuditEventBuilder {
    ...
    pub fn severity<'a>(&'a mut self, val: &str) -> &'a mut AuditEventBuilder {
