...
#[derive(Debug)]
pub struct BodyStructure_ExcludedStructure<'a> {
    pub(crate) value: Cow<'a, Value>,
}

impl BodyStructure_ExcludedStructure<'_> {
    pub fn new(value: &Value) -> BodyStructure_ExcludedStructure {
...
#[derive(Debug)]
pub struct BodyStructure_ExcludedStructureBuilder {
    pub(crate) value: Value,
}

impl BodyStructure_ExcludedStructureBuilder {
    pub fn build(&self) -> BodyStructure_ExcludedStructure {
        BodyStructure_ExcludedStructure {
    ...
    pub fn with(
        existing: BodyStructure_ExcludedStructure,
    ) -> BodyStructure_ExcludedStructureBuilder {
        BodyStructure_ExcludedStructureBuilder {
            value: (*existing.value).clone(),
        }
    }

    pub fn new(structure: CodeableConcept) -> BodyStructure_ExcludedStructureBuilder {
        let mut __value: Value = json!({});
        __value["structure"] = json!(structure.value);
        return BodyStructure_ExcludedStructureBuilder { value: __value };
    }

    pub fn extension<'a>(
        &'a mut self,
        val: Vec<Extension>,
    ) -> &'a mut BodyStructure_ExcludedStructureBuilder {
        self.value["extension"] = json!(val.into_iter().map(|e| e.value).collect::<Vec<_>>());
        return self;
    }

    pub fn id<'a>(&'a mut self, val: &str) -> &'a mut BodyStructure_ExcludedStructureBuilder {
