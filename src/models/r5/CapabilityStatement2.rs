...
use crate::models::r5::CapabilityStatement2_Implementation::CapabilityStatement2_Implementation;
use crate::models::r5::CapabilityStatement2_Rest::CapabilityStatement2_Rest;
use crate::models::r5::CapabilityStatement2_Software::CapabilityStatement2_Software;
...
#[derive(Debug)]
pub struct CapabilityStatement2<'a> {
    pub(crate) value: Cow<'a, Value>,
}

impl CapabilityStatement2<'_> {
    pub fn new(value: &Value) -> CapabilityStatement2 {
    ...
    /// A copyright statement relating to the capability statement2 and/or its contents.
    ...
    /// The date  (and optionally time) when the capability statement2 was published.
    /// The date must change when the business version changes and it must change if the
    /// status code changes. In addition, it should change when the substantive content of
    /// the capability statement2 changes.
    ...
    /// A free text natural language description of the capability statement2 from a
    ...
    /// A Boolean value to indicate that this capability statement2 is authored for
    ...
    /// The version of the FHIR specification that this CapabilityStatement2 describes
    /// (which SHALL be the same as the FHIR version of the CapabilityStatement2 itself).
    ...
    /// software program.
    pub fn implementation(&self) -> Option<CapabilityStatement2_Implementation> {
        if let Some(val) = self.value.get("implementation") {
            return Some(CapabilityStatement2_Implementation {
                value: Cow::Borrowed(val),
            });
        }
        return None;
    ...
    /// Reference to a canonical URL of another CapabilityStatement2 that this software
    ...
    /// the capability statement it claims to implement, so the capability statement must
    ...
    /// A legal or geographic region in which the capability statement2 is intended to
    /// be used.
    ...
    /// A natural language name identifying the capability statement2. This name should be
    ...
    /// Explanation of why this capability statement2 is needed and why it has been
    /// designed as it has.
    ...
    pub fn rest(&self) -> Option<Vec<CapabilityStatement2_Rest>> {
        if let Some(Value::Array(val)) = self.value.get("rest") {
            return Some(
                val.into_iter()
                    .map(|e| CapabilityStatement2_Rest {
                        value: Cow::Borrowed(e),
                    })
                    .collect::<Vec<_>>(),
            );
    ...
    pub fn software(&self) -> Option<CapabilityStatement2_Software> {
        if let Some(val) = self.value.get("software") {
            return Some(CapabilityStatement2_Software {
                value: Cow::Borrowed(val),
            });
        }
        return None;
    ...
    /// The status of this capability statement2. Enables tracking the life-cycle of the
    /// content.
    ...
    /// An absolute URI that is used to identify this capability statement2 when it is
    /// referenced in a specification, model, design or an instance; also called its
    /// canonical identifier. This SHOULD be globally unique and SHOULD be a literal
    /// address at which at which an authoritative instance of this capability statement2
    /// is (or will be) published. This URL can be the target of a canonical reference.
    /// It SHALL remain the same when the capability statement2 is stored on different
    /// servers.
    ...
    /// used to assist with indexing and searching for appropriate capability statement2
    /// instances.
    ...
    /// The identifier that is used to identify this version of the capability statement2
    /// when it is referenced in a specification, model, design or instance. This is an
    /// arbitrary value managed by the capability statement2 author and is not expected
...
#[derive(Debug)]
pub struct CapabilityStatement2Builder {
    pub(crate) value: Value,
}

impl CapabilityStatement2Builder {
    pub fn build(&self) -> CapabilityStatement2 {
        CapabilityStatement2 {
            value: Cow::Owned(self.value.clone()),
        }
    }

    pub fn with(existing: CapabilityStatement2) -> CapabilityStatement2Builder {
        CapabilityStatement2Builder {
            value: (*existing.value).clone(),
        }
    }

    pub fn new() -> CapabilityStatement2Builder {
        let mut __value: Value = json!({});
        return CapabilityStatement2Builder { value: __value };
    }

    pub fn _copyright<'a>(&'a mut self, val: Element) -> &'a mut CapabilityStatement2Builder {
        self.value["_copyright"] = json!(val.value);
        return self;
    }

    pub fn _date<'a>(&'a mut self, val: Element) -> &'a mut CapabilityStatement2Builder {
        self.value["_date"] = json!(val.value);
        return self;
    }

    pub fn _description<'a>(&'a mut self, val: Element) -> &'a mut CapabilityStatement2Builder {
        self.value["_description"] = json!(val.value);
        return self;
    }

    pub fn _experimental<'a>(&'a mut self, val: Element) -> &'a mut CapabilityStatement2Builder {
        self.value["_experimental"] = json!(val.value);
        return self;
    }

    pub fn _fhir_version<'a>(&'a mut self, val: Element) -> &'a mut CapabilityStatement2Builder {
        self.value["_fhirVersion"] = json!(val.value);
        return self;
    }

    pub fn _format<'a>(&'a mut self, val: Vec<Element>) -> &'a mut CapabilityStatement2Builder {
        self.value["_format"] = json!(val.into_iter().map(|e| e.value).collect::<Vec<_>>());
        return self;
    }

    pub fn _implicit_rules<'a>(&'a mut self, val: Element) -> &'a mut CapabilityStatement2Builder {
        self.value["_implicitRules"] = json!(val.value);
        return self;
    }

    pub fn _kind<'a>(&'a mut self, val: Element) -> &'a mut CapabilityStatement2Builder {
        self.value["_kind"] = json!(val.value);
        return self;
    }

    pub fn _language<'a>(&'a mut self, val: Element) -> &'a mut CapabilityStatement2Builder {
        self.value["_language"] = json!(val.value);
        return self;
    }

    pub fn _name<'a>(&'a mut self, val: Element) -> &'a mut CapabilityStatement2Builder {
    ...
    pub fn _patch_format<'a>(
        &'a mut self,
        val: Vec<Element>,
    ) -> &'a mut CapabilityStatement2Builder {
        self.value["_patchFormat"] = json!(val.into_iter().map(|e| e.value).collect::<Vec<_>>());
        return self;
    }

    pub fn _publisher<'a>(&'a mut self, val: Element) -> &'a mut CapabilityStatement2Builder {
        self.value["_publisher"] = json!(val.value);
        return self;
    }

    pub fn _purpose<'a>(&'a mut self, val: Element) -> &'a mut CapabilityStatement2Builder {
        self.value["_purpose"] = json!(val.value);
        return self;
    }

    pub fn _status<'a>(&'a mut self, val: Element) -> &'a mut CapabilityStatement2Builder {
        self.value["_status"] = json!(val.value);
        return self;
    }

    pub fn _title<'a>(&'a mut self, val: Element) -> &'a mut CapabilityStatement2Builder {
        self.value["_title"] = json!(val.value);
        return self;
    }

    pub fn _url<'a>(&'a mut self, val: Element) -> &'a mut CapabilityStatement2Builder {
        self.value["_url"] = json!(val.value);
        return self;
    }

    pub fn _version<'a>(&'a mut self, val: Element) -> &'a mut CapabilityStatement2Builder {
    ...
    pub fn copyright<'a>(&'a mut self, val: &str) -> &'a mut CapabilityStatement2Builder {
        self.value["copyright"] = json!(val);
        return self;
    }

    pub fn date<'a>(&'a mut self, val: &str) -> &'a mut CapabilityStatement2Builder {
        self.value["date"] = json!(val);
        return self;
    }

    pub fn description<'a>(&'a mut self, val: &str) -> &'a mut CapabilityStatement2Builder {
        self.value["description"] = json!(val);
        return self;
    }

    pub fn experimental<'a>(&'a mut self, val: bool) -> &'a mut CapabilityStatement2Builder {
        self.value["experimental"] = json!(val);
        return self;
    }

    pub fn extension<'a>(&'a mut self, val: Vec<Extension>) -> &'a mut CapabilityStatement2Builder {
        self.value["extension"] = json!(val.into_iter().map(|e| e.value).collect::<Vec<_>>());
        return self;
    }

    pub fn fhir_version<'a>(&'a mut self, val: &str) -> &'a mut CapabilityStatement2Builder {
        self.value["fhirVersion"] = json!(val);
        return self;
    }

    pub fn format<'a>(&'a mut self, val: Vec<&str>) -> &'a mut CapabilityStatement2Builder {
        self.value["format"] = json!(val);
        return self;
    }

    pub fn id<'a>(&'a mut self, val: &str) -> &'a mut CapabilityStatement2Builder {
    ...
    pub fn implementation<'a>(
        &'a mut self,
        val: CapabilityStatement2_Implementation,
    ) -> &'a mut CapabilityStatement2Builder {
    ...
    pub fn implicit_rules<'a>(&'a mut self, val: &str) -> &'a mut CapabilityStatement2Builder {
        self.value["implicitRules"] = json!(val);
        return self;
    }

    pub fn imports<'a>(&'a mut self, val: Vec<&str>) -> &'a mut CapabilityStatement2Builder {
        self.value["imports"] = json!(val);
        return self;
    }

    pub fn instantiates<'a>(&'a mut self, val: Vec<&str>) -> &'a mut CapabilityStatement2Builder {
    ...
    pub fn kind<'a>(&'a mut self, val: &str) -> &'a mut CapabilityStatement2Builder {
        self.value["kind"] = json!(val);
        return self;
    }

    pub fn language<'a>(&'a mut self, val: &str) -> &'a mut CapabilityStatement2Builder {
        self.value["language"] = json!(val);
        return self;
    }

    pub fn meta<'a>(&'a mut self, val: Meta) -> &'a mut CapabilityStatement2Builder {
    ...
    pub fn name<'a>(&'a mut self, val: &str) -> &'a mut CapabilityStatement2Builder {
        self.value["name"] = json!(val);
        return self;
    }

    pub fn patch_format<'a>(&'a mut self, val: Vec<&str>) -> &'a mut CapabilityStatement2Builder {
        self.value["patchFormat"] = json!(val);
        return self;
    }

    pub fn publisher<'a>(&'a mut self, val: &str) -> &'a mut CapabilityStatement2Builder {
        self.value["publisher"] = json!(val);
        return self;
    }

    pub fn purpose<'a>(&'a mut self, val: &str) -> &'a mut CapabilityStatement2Builder {
    ...
    pub fn rest<'a>(
        &'a mut self,
        val: Vec<CapabilityStatement2_Rest>,
    ) -> &'a mut CapabilityStatement2Builder {
    ...
    pub fn software<'a>(
        &'a mut self,
        val: CapabilityStatement2_Software,
    ) -> &'a mut CapabilityStatement2Builder {
        self.value["software"] = json!(val.value);
        return self;
    }

    pub fn status<'a>(&'a mut self, val: &str) -> &'a mut CapabilityStatement2Builder {
        self.value["status"] = json!(val);
        return self;
    }

    pub fn text<'a>(&'a mut self, val: Narrative) -> &'a mut CapabilityStatement2Builder {
        self.value["text"] = json!(val.value);
        return self;
    }

    pub fn title<'a>(&'a mut self, val: &str) -> &'a mut CapabilityStatement2Builder {
        self.value["title"] = json!(val);
        return self;
    }

    pub fn url<'a>(&'a mut self, val: &str) -> &'a mut CapabilityStatement2Builder {
    ...
    pub fn version<'a>(&'a mut self, val: &str) -> &'a mut CapabilityStatement2Builder {
