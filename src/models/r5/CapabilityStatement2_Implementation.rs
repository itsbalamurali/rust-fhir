...
#[derive(Debug)]
pub struct CapabilityStatement2_Implementation<'a> {
    pub(crate) value: Cow<'a, Value>,
}

impl CapabilityStatement2_Implementation<'_> {
    pub fn new(value: &Value) -> CapabilityStatement2_Implementation {
...
#[derive(Debug)]
pub struct CapabilityStatement2_ImplementationBuilder {
    pub(crate) value: Value,
}

impl CapabilityStatement2_ImplementationBuilder {
    pub fn build(&self) -> CapabilityStatement2_Implementation {
        CapabilityStatement2_Implementation {
    ...
    pub fn with(
        existing: CapabilityStatement2_Implementation,
    ) -> CapabilityStatement2_ImplementationBuilder {
        CapabilityStatement2_ImplementationBuilder {
            value: (*existing.value).clone(),
        }
    }

    pub fn new() -> CapabilityStatement2_ImplementationBuilder {
        let mut __value: Value = json!({});
        return CapabilityStatement2_ImplementationBuilder { value: __value };
    }

    pub fn _description<'a>(
        &'a mut self,
        val: Element,
    ) -> &'a mut CapabilityStatement2_ImplementationBuilder {
    ...
    pub fn id<'a>(&'a mut self, val: &str) -> &'a mut CapabilityStatement2_ImplementationBuilder {
    ...
    pub fn url<'a>(&'a mut self, val: &str) -> &'a mut CapabilityStatement2_ImplementationBuilder {
