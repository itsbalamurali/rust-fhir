...
#[derive(Debug)]
pub struct CapabilityStatement2_Interaction<'a> {
    pub(crate) value: Cow<'a, Value>,
}

impl CapabilityStatement2_Interaction<'_> {
    pub fn new(value: &Value) -> CapabilityStatement2_Interaction {
...
#[derive(Debug)]
pub struct CapabilityStatement2_InteractionBuilder {
    pub(crate) value: Value,
}

impl CapabilityStatement2_InteractionBuilder {
    pub fn build(&self) -> CapabilityStatement2_Interaction {
        CapabilityStatement2_Interaction {
    ...
    pub fn with(
        existing: CapabilityStatement2_Interaction,
    ) -> CapabilityStatement2_InteractionBuilder {
        CapabilityStatement2_InteractionBuilder {
            value: (*existing.value).clone(),
        }
    }

    pub fn new() -> CapabilityStatement2_InteractionBuilder {
        let mut __value: Value = json!({});
        return CapabilityStatement2_InteractionBuilder { value: __value };
    }

    pub fn _code<'a>(
        &'a mut self,
        val: Element,
    ) -> &'a mut CapabilityStatement2_InteractionBuilder {
    ...
    pub fn code<'a>(&'a mut self, val: &str) -> &'a mut CapabilityStatement2_InteractionBuilder {
    ...
    pub fn id<'a>(&'a mut self, val: &str) -> &'a mut CapabilityStatement2_InteractionBuilder {
