...
use crate::models::r5::CapabilityStatement_Endpoint::CapabilityStatement_Endpoint;
use crate::models::r5::CapabilityStatement_SupportedMessage::CapabilityStatement_SupportedMessage;
