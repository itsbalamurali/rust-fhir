...
use crate::models::r5::CarePlan_Activity::CarePlan_Activity;
...
impl CarePlan<'_> {
    ...
    pub fn addresses(&self) -> Option<Vec<CodeableReference>> {
...
impl CarePlanBuilder {
    ...
    pub fn addresses<'a>(&'a mut self, val: Vec<CodeableReference>) -> &'a mut CarePlanBuilder {
