...
use crate::models::r5::ChargeItem_Performer::ChargeItem_Performer;
...
impl ChargeItem<'_> {
    ...
    pub fn product(&self) -> Option<Vec<CodeableReference>> {
...
impl ChargeItemBuilder {
    ...
    pub fn product<'a>(&'a mut self, val: Vec<CodeableReference>) -> &'a mut ChargeItemBuilder {
    ...
    pub fn status<'a>(&'a mut self, val: &str) -> &'a mut ChargeItemBuilder {
