...
use crate::models::r5::ChargeItemDefinition_Applicability::ChargeItemDefinition_Applicability;
use crate::models::r5::ChargeItemDefinition_PropertyGroup::ChargeItemDefinition_PropertyGroup;
...
impl ChargeItemDefinition<'_> {
    ...
    /// address at which at which an authoritative instance of this charge item definition
    ...
    /// used to assist with indexing and searching for appropriate charge item definition
    /// instances.
    ...
    /// arbitrary value managed by the charge item definition author and is not expected
...
impl ChargeItemDefinitionBuilder {
    ...
    pub fn _name<'a>(&'a mut self, val: Element) -> &'a mut ChargeItemDefinitionBuilder {
    ...
    pub fn _purpose<'a>(&'a mut self, val: Element) -> &'a mut ChargeItemDefinitionBuilder {
    ...
    pub fn name<'a>(&'a mut self, val: &str) -> &'a mut ChargeItemDefinitionBuilder {
    ...
    pub fn purpose<'a>(&'a mut self, val: &str) -> &'a mut ChargeItemDefinitionBuilder {
    ...
    pub fn status<'a>(&'a mut self, val: &str) -> &'a mut ChargeItemDefinitionBuilder {
