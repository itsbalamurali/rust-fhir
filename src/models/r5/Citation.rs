...
use crate::models::r5::Citation_CitedArtifact::Citation_CitedArtifact;
use crate::models::r5::Citation_Classification::Citation_Classification;
use crate::models::r5::Citation_StatusDate::Citation_StatusDate;
use crate::models::r5::Citation_Summary::Citation_Summary;
...
impl CitationBuilder {
    ...
    pub fn topic<'a>(&'a mut self, val: Vec<CodeableConcept>) -> &'a mut CitationBuilder {
