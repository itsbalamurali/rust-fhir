...
use crate::models::r5::Citation_Abstract::Citation_Abstract;
use crate::models::r5::Citation_Classification1::Citation_Classification1;
use crate::models::r5::Citation_Contributorship::Citation_Contributorship;
use crate::models::r5::Citation_Part::Citation_Part;
use crate::models::r5::Citation_PublicationForm::Citation_PublicationForm;
use crate::models::r5::Citation_StatusDate1::Citation_StatusDate1;
use crate::models::r5::Citation_Title::Citation_Title;
use crate::models::r5::Citation_Version::Citation_Version;
use crate::models::r5::Citation_WebLocation::Citation_WebLocation;
...
impl Citation_CitedArtifact<'_> {
    ...
    pub fn relates_to(&self) -> Option<Vec<RelatedArtifact>> {
