...
use crate::models::r5::Citation_AffiliationInfo::Citation_AffiliationInfo;
use crate::models::r5::Citation_ContributionInstance::Citation_ContributionInstance;
...
impl Citation_Entry<'_> {
    ...
    pub fn _ranking_order(&self) -> Option<Element> {
        if let Some(val) = self.value.get("_rankingOrder") {
            return Some(Element {
                value: Cow::Borrowed(val),
            });
        }
    ...
    pub fn ranking_order(&self) -> Option<i64> {
        if let Some(val) = self.value.get("rankingOrder") {
    ...
    pub fn validate(&self) -> bool {
        ...
        if let Some(_val) = self._ranking_order() {
            if !_val.validate() {
                return false;
            }
        }
        ...
        if let Some(_val) = self.ranking_order() {}
...
impl Citation_EntryBuilder {
    ...
    pub fn _ranking_order<'a>(&'a mut self, val: Element) -> &'a mut Citation_EntryBuilder {
        self.value["_rankingOrder"] = json!(val.value);
        return self;
    }
    ...
    pub fn ranking_order<'a>(&'a mut self, val: i64) -> &'a mut Citation_EntryBuilder {
        self.value["rankingOrder"] = json!(val);
        return self;
    }
