...
use crate::models::r5::ClinicalUseDefinition_OtherTherapy::ClinicalUseDefinition_OtherTherapy;
...
#[derive(Debug)]
pub struct ClinicalUseDefinition_Contraindication<'a> {
    pub(crate) value: Cow<'a, Value>,
}

impl ClinicalUseDefinition_Contraindication<'_> {
    pub fn new(value: &Value) -> ClinicalUseDefinition_Contraindication {
...
#[derive(Debug)]
pub struct ClinicalUseDefinition_ContraindicationBuilder {
    pub(crate) value: Value,
}

impl ClinicalUseDefinition_ContraindicationBuilder {
    pub fn build(&self) -> ClinicalUseDefinition_Contraindication {
        ClinicalUseDefinition_Contraindication {
    ...
    pub fn with(
        existing: ClinicalUseDefinition_Contraindication,
    ) -> ClinicalUseDefinition_ContraindicationBuilder {
        ClinicalUseDefinition_ContraindicationBuilder {
            value: (*existing.value).clone(),
        }
    }

    pub fn new() -> ClinicalUseDefinition_ContraindicationBuilder {
        let mut __value: Value = json!({});
        return ClinicalUseDefinition_ContraindicationBuilder { value: __value };
    }

    pub fn comorbidity<'a>(
        &'a mut self,
        val: Vec<CodeableReference>,
    ) -> &'a mut ClinicalUseDefinition_ContraindicationBuilder {
