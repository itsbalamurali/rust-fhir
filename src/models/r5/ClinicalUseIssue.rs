...
impl ClinicalUseIssue<'_> {
    ...
    /// General description of an effect (particularly for a general
    /// warning, rather than any of the more specific types such as
    /// indication) for when a distinct coded or textual description is
    /// not appropriate using  Indication.diseaseSymptomProcedure.text,
    /// Contraindication.diseaseSymptomProcedure.text etc. For example "May affect ability
    /// to drive".
