...
#[derive(Debug)]
pub struct ClinicalUseIssue_Indication<'a> {
    pub(crate) value: Cow<'a, Value>,
}

impl ClinicalUseIssue_Indication<'_> {
    pub fn new(value: &Value) -> ClinicalUseIssue_Indication {
...
#[derive(Debug)]
pub struct ClinicalUseIssue_IndicationBuilder {
    pub(crate) value: Value,
}

impl ClinicalUseIssue_IndicationBuilder {
    pub fn build(&self) -> ClinicalUseIssue_Indication {
        ClinicalUseIssue_Indication {
            value: Cow::Owned(self.value.clone()),
        }
    }

    pub fn with(existing: ClinicalUseIssue_Indication) -> ClinicalUseIssue_IndicationBuilder {
        ClinicalUseIssue_IndicationBuilder {
            value: (*existing.value).clone(),
        }
    }

    pub fn new() -> ClinicalUseIssue_IndicationBuilder {
        let mut __value: Value = json!({});
        return ClinicalUseIssue_IndicationBuilder { value: __value };
    }

    pub fn comorbidity<'a>(
        &'a mut self,
        val: Vec<CodeableReference>,
    ) -> &'a mut ClinicalUseIssue_IndicationBuilder {
    ...
    pub fn duration<'a>(&'a mut self, val: Quantity) -> &'a mut ClinicalUseIssue_IndicationBuilder {
    ...
    pub fn id<'a>(&'a mut self, val: &str) -> &'a mut ClinicalUseIssue_IndicationBuilder {
