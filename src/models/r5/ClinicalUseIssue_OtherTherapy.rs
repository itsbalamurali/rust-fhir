...
#[derive(Debug)]
pub struct ClinicalUseIssue_OtherTherapy<'a> {
    pub(crate) value: Cow<'a, Value>,
}

impl ClinicalUseIssue_OtherTherapy<'_> {
    pub fn new(value: &Value) -> ClinicalUseIssue_OtherTherapy {
...
#[derive(Debug)]
pub struct ClinicalUseIssue_OtherTherapyBuilder {
    pub(crate) value: Value,
}

impl ClinicalUseIssue_OtherTherapyBuilder {
    pub fn build(&self) -> ClinicalUseIssue_OtherTherapy {
        ClinicalUseIssue_OtherTherapy {
            value: Cow::Owned(self.value.clone()),
        }
    }

    pub fn with(existing: ClinicalUseIssue_OtherTherapy) -> ClinicalUseIssue_OtherTherapyBuilder {
        ClinicalUseIssue_OtherTherapyBuilder {
    ...
    pub fn new(
        ...
        return ClinicalUseIssue_OtherTherapyBuilder { value: __value };
    }

    pub fn extension<'a>(
        &'a mut self,
        val: Vec<Extension>,
    ) -> &'a mut ClinicalUseIssue_OtherTherapyBuilder {
        self.value["extension"] = json!(val.into_iter().map(|e| e.value).collect::<Vec<_>>());
        return self;
    }

    pub fn id<'a>(&'a mut self, val: &str) -> &'a mut ClinicalUseIssue_OtherTherapyBuilder {
