...
#[derive(Debug)]
pub struct ClinicalUseIssue_UndesirableEffect<'a> {
    pub(crate) value: Cow<'a, Value>,
}

impl ClinicalUseIssue_UndesirableEffect<'_> {
    pub fn new(value: &Value) -> ClinicalUseIssue_UndesirableEffect {
...
#[derive(Debug)]
pub struct ClinicalUseIssue_UndesirableEffectBuilder {
    pub(crate) value: Value,
}

impl ClinicalUseIssue_UndesirableEffectBuilder {
    pub fn build(&self) -> ClinicalUseIssue_UndesirableEffect {
        ClinicalUseIssue_UndesirableEffect {
    ...
    pub fn with(
        existing: ClinicalUseIssue_UndesirableEffect,
    ) -> ClinicalUseIssue_UndesirableEffectBuilder {
        ClinicalUseIssue_UndesirableEffectBuilder {
            value: (*existing.value).clone(),
        }
    }

    pub fn new() -> ClinicalUseIssue_UndesirableEffectBuilder {
        let mut __value: Value = json!({});
        return ClinicalUseIssue_UndesirableEffectBuilder { value: __value };
    }

    pub fn classification<'a>(
        &'a mut self,
        val: CodeableConcept,
    ) -> &'a mut ClinicalUseIssue_UndesirableEffectBuilder {
    ...
    pub fn id<'a>(&'a mut self, val: &str) -> &'a mut ClinicalUseIssue_UndesirableEffectBuilder {
