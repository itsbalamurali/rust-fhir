...
use crate::models::r5::CompartmentDefinition_Resource::CompartmentDefinition_Resource;
...
impl CompartmentDefinition<'_> {
    ...
    /// address at which at which an authoritative instance of this compartment definition
    ...
    /// used to assist with indexing and searching for appropriate compartment definition
    /// instances.
    ...
    /// arbitrary value managed by the compartment definition author and is not expected
...
impl CompartmentDefinitionBuilder {
    ...
    pub fn _copyright<'a>(&'a mut self, val: Element) -> &'a mut CompartmentDefinitionBuilder {
    ...
    pub fn _title<'a>(&'a mut self, val: Element) -> &'a mut CompartmentDefinitionBuilder {
    ...
    pub fn code<'a>(&'a mut self, val: &str) -> &'a mut CompartmentDefinitionBuilder {
    ...
    pub fn copyright<'a>(&'a mut self, val: &str) -> &'a mut CompartmentDefinitionBuilder {
    ...
    pub fn status<'a>(&'a mut self, val: &str) -> &'a mut CompartmentDefinitionBuilder {
    ...
    pub fn title<'a>(&'a mut self, val: &str) -> &'a mut CompartmentDefinitionBuilder {
