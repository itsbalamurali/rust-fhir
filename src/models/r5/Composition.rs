...
use crate::models::r5::Composition_Attester::Composition_Attester;
use crate::models::r5::Composition_Event::Composition_Event;
use crate::models::r5::Composition_Section::Composition_Section;
...
impl CompositionBuilder {
    ...
    pub fn relates_to<'a>(&'a mut self, val: Vec<RelatedArtifact>) -> &'a mut CompositionBuilder {
    ...
    pub fn status<'a>(&'a mut self, val: &str) -> &'a mut CompositionBuilder {
