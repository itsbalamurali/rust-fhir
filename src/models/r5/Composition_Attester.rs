...
impl Composition_Attester<'_> {
    ...
    pub fn mode(&self) -> CodeableConcept {
        CodeableConcept {
            value: Cow::Borrowed(&self.value["mode"]),
        }
    }
...
impl Composition_AttesterBuilder {
    ...
    pub fn new(mode: CodeableConcept) -> Composition_AttesterBuilder {
        let mut __value: Value = json!({});
        __value["mode"] = json!(mode.value);
