...
use crate::models::r5::ConceptMap_Group::ConceptMap_Group;
...
impl ConceptMapBuilder {
    ...
    pub fn identifier<'a>(&'a mut self, val: Vec<Identifier>) -> &'a mut ConceptMapBuilder {
    ...
    pub fn status<'a>(&'a mut self, val: &str) -> &'a mut ConceptMapBuilder {
