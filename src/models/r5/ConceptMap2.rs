...
use crate::models::r5::ConceptMap2_Group::ConceptMap2_Group;
...
#[derive(Debug)]
pub struct ConceptMap2<'a> {
    pub(crate) value: Cow<'a, Value>,
}

impl ConceptMap2<'_> {
    pub fn new(value: &Value) -> ConceptMap2 {
        ConceptMap2 {
    ...
    pub fn group(&self) -> Option<Vec<ConceptMap2_Group>> {
        if let Some(Value::Array(val)) = self.value.get("group") {
            return Some(
                val.into_iter()
                    .map(|e| ConceptMap2_Group {
                        value: Cow::Borrowed(e),
                    })
                    .collect::<Vec<_>>(),
            );
    ...
    /// value managed by the concept map author and is not expected to be globally unique.
...
#[derive(Debug)]
pub struct ConceptMap2Builder {
    pub(crate) value: Value,
}

impl ConceptMap2Builder {
    pub fn build(&self) -> ConceptMap2 {
        ConceptMap2 {
            value: Cow::Owned(self.value.clone()),
        }
    }

    pub fn with(existing: ConceptMap2) -> ConceptMap2Builder {
        ConceptMap2Builder {
            value: (*existing.value).clone(),
        }
    }

    pub fn new() -> ConceptMap2Builder {
        let mut __value: Value = json!({});
        return ConceptMap2Builder { value: __value };
    }

    pub fn _copyright<'a>(&'a mut self, val: Element) -> &'a mut ConceptMap2Builder {
        self.value["_copyright"] = json!(val.value);
        return self;
    }

    pub fn _date<'a>(&'a mut self, val: Element) -> &'a mut ConceptMap2Builder {
        self.value["_date"] = json!(val.value);
        return self;
    }

    pub fn _description<'a>(&'a mut self, val: Element) -> &'a mut ConceptMap2Builder {
        self.value["_description"] = json!(val.value);
        return self;
    }

    pub fn _experimental<'a>(&'a mut self, val: Element) -> &'a mut ConceptMap2Builder {
        self.value["_experimental"] = json!(val.value);
        return self;
    }

    pub fn _implicit_rules<'a>(&'a mut self, val: Element) -> &'a mut ConceptMap2Builder {
        self.value["_implicitRules"] = json!(val.value);
        return self;
    }

    pub fn _language<'a>(&'a mut self, val: Element) -> &'a mut ConceptMap2Builder {
        self.value["_language"] = json!(val.value);
        return self;
    }

    pub fn _name<'a>(&'a mut self, val: Element) -> &'a mut ConceptMap2Builder {
        self.value["_name"] = json!(val.value);
        return self;
    }

    pub fn _publisher<'a>(&'a mut self, val: Element) -> &'a mut ConceptMap2Builder {
        self.value["_publisher"] = json!(val.value);
        return self;
    }

    pub fn _purpose<'a>(&'a mut self, val: Element) -> &'a mut ConceptMap2Builder {
        self.value["_purpose"] = json!(val.value);
        return self;
    }

    pub fn _source_canonical<'a>(&'a mut self, val: Element) -> &'a mut ConceptMap2Builder {
        self.value["_sourceCanonical"] = json!(val.value);
        return self;
    }

    pub fn _source_uri<'a>(&'a mut self, val: Element) -> &'a mut ConceptMap2Builder {
        self.value["_sourceUri"] = json!(val.value);
        return self;
    }

    pub fn _status<'a>(&'a mut self, val: Element) -> &'a mut ConceptMap2Builder {
        self.value["_status"] = json!(val.value);
        return self;
    }

    pub fn _target_canonical<'a>(&'a mut self, val: Element) -> &'a mut ConceptMap2Builder {
        self.value["_targetCanonical"] = json!(val.value);
        return self;
    }

    pub fn _target_uri<'a>(&'a mut self, val: Element) -> &'a mut ConceptMap2Builder {
        self.value["_targetUri"] = json!(val.value);
        return self;
    }

    pub fn _title<'a>(&'a mut self, val: Element) -> &'a mut ConceptMap2Builder {
        self.value["_title"] = json!(val.value);
        return self;
    }

    pub fn _url<'a>(&'a mut self, val: Element) -> &'a mut ConceptMap2Builder {
        self.value["_url"] = json!(val.value);
        return self;
    }

    pub fn _version<'a>(&'a mut self, val: Element) -> &'a mut ConceptMap2Builder {
        self.value["_version"] = json!(val.value);
        return self;
    }

    pub fn contact<'a>(&'a mut self, val: Vec<ContactDetail>) -> &'a mut ConceptMap2Builder {
        self.value["contact"] = json!(val.into_iter().map(|e| e.value).collect::<Vec<_>>());
        return self;
    }

    pub fn contained<'a>(&'a mut self, val: Vec<ResourceList>) -> &'a mut ConceptMap2Builder {
        self.value["contained"] = json!(val.into_iter().map(|e| e.value).collect::<Vec<_>>());
        return self;
    }

    pub fn copyright<'a>(&'a mut self, val: &str) -> &'a mut ConceptMap2Builder {
        self.value["copyright"] = json!(val);
        return self;
    }

    pub fn date<'a>(&'a mut self, val: &str) -> &'a mut ConceptMap2Builder {
        self.value["date"] = json!(val);
        return self;
    }

    pub fn description<'a>(&'a mut self, val: &str) -> &'a mut ConceptMap2Builder {
        self.value["description"] = json!(val);
        return self;
    }

    pub fn experimental<'a>(&'a mut self, val: bool) -> &'a mut ConceptMap2Builder {
        self.value["experimental"] = json!(val);
        return self;
    }

    pub fn extension<'a>(&'a mut self, val: Vec<Extension>) -> &'a mut ConceptMap2Builder {
        self.value["extension"] = json!(val.into_iter().map(|e| e.value).collect::<Vec<_>>());
        return self;
    }

    pub fn group<'a>(&'a mut self, val: Vec<ConceptMap2_Group>) -> &'a mut ConceptMap2Builder {
        self.value["group"] = json!(val.into_iter().map(|e| e.value).collect::<Vec<_>>());
        return self;
    }

    pub fn id<'a>(&'a mut self, val: &str) -> &'a mut ConceptMap2Builder {
        self.value["id"] = json!(val);
        return self;
    }

    pub fn identifier<'a>(&'a mut self, val: Vec<Identifier>) -> &'a mut ConceptMap2Builder {
        self.value["identifier"] = json!(val.into_iter().map(|e| e.value).collect::<Vec<_>>());
        return self;
    }

    pub fn implicit_rules<'a>(&'a mut self, val: &str) -> &'a mut ConceptMap2Builder {
        self.value["implicitRules"] = json!(val);
        return self;
    }

    pub fn jurisdiction<'a>(&'a mut self, val: Vec<CodeableConcept>) -> &'a mut ConceptMap2Builder {
        self.value["jurisdiction"] = json!(val.into_iter().map(|e| e.value).collect::<Vec<_>>());
        return self;
    }

    pub fn language<'a>(&'a mut self, val: &str) -> &'a mut ConceptMap2Builder {
        self.value["language"] = json!(val);
        return self;
    }

    pub fn meta<'a>(&'a mut self, val: Meta) -> &'a mut ConceptMap2Builder {
        self.value["meta"] = json!(val.value);
        return self;
    }

    pub fn modifier_extension<'a>(&'a mut self, val: Vec<Extension>) -> &'a mut ConceptMap2Builder {
        self.value["modifierExtension"] =
            json!(val.into_iter().map(|e| e.value).collect::<Vec<_>>());
        return self;
    }

    pub fn name<'a>(&'a mut self, val: &str) -> &'a mut ConceptMap2Builder {
        self.value["name"] = json!(val);
        return self;
    }

    pub fn publisher<'a>(&'a mut self, val: &str) -> &'a mut ConceptMap2Builder {
        self.value["publisher"] = json!(val);
        return self;
    }

    pub fn purpose<'a>(&'a mut self, val: &str) -> &'a mut ConceptMap2Builder {
        self.value["purpose"] = json!(val);
        return self;
    }

    pub fn source_canonical<'a>(&'a mut self, val: &str) -> &'a mut ConceptMap2Builder {
        self.value["sourceCanonical"] = json!(val);
        return self;
    }

    pub fn source_uri<'a>(&'a mut self, val: &str) -> &'a mut ConceptMap2Builder {
        self.value["sourceUri"] = json!(val);
        return self;
    }

    pub fn status<'a>(&'a mut self, val: &str) -> &'a mut ConceptMap2Builder {
        self.value["status"] = json!(val);
        return self;
    }

    pub fn target_canonical<'a>(&'a mut self, val: &str) -> &'a mut ConceptMap2Builder {
        self.value["targetCanonical"] = json!(val);
        return self;
    }

    pub fn target_uri<'a>(&'a mut self, val: &str) -> &'a mut ConceptMap2Builder {
        self.value["targetUri"] = json!(val);
        return self;
    }

    pub fn text<'a>(&'a mut self, val: Narrative) -> &'a mut ConceptMap2Builder {
        self.value["text"] = json!(val.value);
        return self;
    }

    pub fn title<'a>(&'a mut self, val: &str) -> &'a mut ConceptMap2Builder {
        self.value["title"] = json!(val);
        return self;
    }

    pub fn url<'a>(&'a mut self, val: &str) -> &'a mut ConceptMap2Builder {
        self.value["url"] = json!(val);
        return self;
    }

    pub fn use_context<'a>(&'a mut self, val: Vec<UsageContext>) -> &'a mut ConceptMap2Builder {
        self.value["useContext"] = json!(val.into_iter().map(|e| e.value).collect::<Vec<_>>());
        return self;
    }

    pub fn version<'a>(&'a mut self, val: &str) -> &'a mut ConceptMap2Builder {
