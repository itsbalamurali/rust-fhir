...
use crate::models::r5::ConceptMap_Target::ConceptMap_Target;
...
impl ConceptMap_Element<'_> {
    ...
    /// If noMap = true this indicates that no mapping to a target concept exists for this
    /// source concept.
...
impl ConceptMap_ElementBuilder {
    ...
    pub fn _no_map<'a>(&'a mut self, val: Element) -> &'a mut ConceptMap_ElementBuilder {
    ...
    pub fn no_map<'a>(&'a mut self, val: bool) -> &'a mut ConceptMap_ElementBuilder {
