...
use crate::models::r5::Condition_Evidence::Condition_Evidence;
use crate::models::r5::Condition_Stage::Condition_Stage;
...
impl Condition<'_> {
    ...
    /// This is called "abatement" because of the many overloaded connotations associated
    /// with "remission" or "resolution" - Some conditions, such as chronic conditions,
    ...
    pub fn clinical_status(&self) -> CodeableConcept {
        CodeableConcept {
            value: Cow::Borrowed(&self.value["clinicalStatus"]),
        }
    }
    ...
    pub fn validate(&self) -> bool {
        ...
        if !self.clinical_status().validate() {
            return false;
        }
...
impl ConditionBuilder {
    ...
    pub fn new(clinical_status: CodeableConcept, subject: Reference) -> ConditionBuilder {
        let mut __value: Value = json!({});
        __value["clinicalStatus"] = json!(clinical_status.value);
