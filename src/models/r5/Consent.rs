...
use crate::models::r5::Consent_Policy::Consent_Policy;
use crate::models::r5::Consent_Provision::Consent_Provision;
use crate::models::r5::Consent_Verification::Consent_Verification;
...
impl Consent<'_> {
    ...
    pub fn controller(&self) -> Option<Vec<Reference>> {
        if let Some(Value::Array(val)) = self.value.get("controller") {
            return Some(
                val.into_iter()
                    .map(|e| Reference {
                        value: Cow::Borrowed(e),
    ...
    pub fn grantee(&self) -> Option<Vec<Reference>> {
        if let Some(Value::Array(val)) = self.value.get("grantee") {
            return Some(
                val.into_iter()
                    .map(|e| Reference {
                        value: Cow::Borrowed(e),
    ...
    pub fn grantor(&self) -> Option<Vec<Reference>> {
        if let Some(Value::Array(val)) = self.value.get("grantor") {
            return Some(
                val.into_iter()
                    .map(|e| Reference {
                        value: Cow::Borrowed(e),
    ...
    pub fn manager(&self) -> Option<Vec<Reference>> {
        if let Some(Value::Array(val)) = self.value.get("manager") {
            return Some(
                val.into_iter()
                    .map(|e| Reference {
                        value: Cow::Borrowed(e),
    ...
    pub fn source_attachment(&self) -> Option<Vec<Attachment>> {
        if let Some(Value::Array(val)) = self.value.get("sourceAttachment") {
            return Some(
                val.into_iter()
                    .map(|e| Attachment {
                        value: Cow::Borrowed(e),
    ...
    pub fn source_reference(&self) -> Option<Vec<Reference>> {
        if let Some(Value::Array(val)) = self.value.get("sourceReference") {
            return Some(
                val.into_iter()
                    .map(|e| Reference {
                        value: Cow::Borrowed(e),
    ...
    pub fn validate(&self) -> bool {
        ...
        if let Some(_val) = self.controller() {
            if !_val.into_iter().map(|e| e.validate()).all(|x| x == true) {
                return false;
            }
        }
        ...
        if let Some(_val) = self.grantee() {
            if !_val.into_iter().map(|e| e.validate()).all(|x| x == true) {
                return false;
            }
        }
        if let Some(_val) = self.grantor() {
            if !_val.into_iter().map(|e| e.validate()).all(|x| x == true) {
                return false;
            }
        }
...
impl ConsentBuilder {
    ...
    pub fn category<'a>(&'a mut self, val: Vec<CodeableConcept>) -> &'a mut ConsentBuilder {
    ...
    pub fn controller<'a>(&'a mut self, val: Vec<Reference>) -> &'a mut ConsentBuilder {
        self.value["controller"] = json!(val.into_iter().map(|e| e.value).collect::<Vec<_>>());
        return self;
    }
    ...
    pub fn grantee<'a>(&'a mut self, val: Vec<Reference>) -> &'a mut ConsentBuilder {
        self.value["grantee"] = json!(val.into_iter().map(|e| e.value).collect::<Vec<_>>());
        return self;
    }

    pub fn grantor<'a>(&'a mut self, val: Vec<Reference>) -> &'a mut ConsentBuilder {
        self.value["grantor"] = json!(val.into_iter().map(|e| e.value).collect::<Vec<_>>());
        return self;
    }
    ...
    pub fn manager<'a>(&'a mut self, val: Vec<Reference>) -> &'a mut ConsentBuilder {
        self.value["manager"] = json!(val.into_iter().map(|e| e.value).collect::<Vec<_>>());
        return self;
    }
    ...
    pub fn source_attachment<'a>(&'a mut self, val: Vec<Attachment>) -> &'a mut ConsentBuilder {
        self.value["sourceAttachment"] =
            json!(val.into_iter().map(|e| e.value).collect::<Vec<_>>());
        return self;
    }

    pub fn source_reference<'a>(&'a mut self, val: Vec<Reference>) -> &'a mut ConsentBuilder {
        self.value["sourceReference"] = json!(val.into_iter().map(|e| e.value).collect::<Vec<_>>());
        return self;
    }

    pub fn status<'a>(&'a mut self, val: &str) -> &'a mut ConsentBuilder {
        self.value["status"] = json!(val);
        return self;
    }

    pub fn subject<'a>(&'a mut self, val: Reference) -> &'a mut ConsentBuilder {
