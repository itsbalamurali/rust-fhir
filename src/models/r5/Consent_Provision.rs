...
use crate::models::r5::Consent_Actor::Consent_Actor;
use crate::models::r5::Consent_Data::Consent_Data;
...
impl Consent_ProvisionBuilder {
    ...
    pub fn expression<'a>(&'a mut self, val: Expression) -> &'a mut Consent_ProvisionBuilder {
    ...
    pub fn fhir_type<'a>(&'a mut self, val: &str) -> &'a mut Consent_ProvisionBuilder {
