...
impl Consent_Verification<'_> {
    ...
    pub fn _verification_date(&self) -> Option<Vec<Element>> {
        if let Some(Value::Array(val)) = self.value.get("_verificationDate") {
            return Some(
                val.into_iter()
                    .map(|e| Element {
    ...
    pub fn verification_date(&self) -> Option<Vec<&str>> {
        if let Some(Value::Array(val)) = self.value.get("verificationDate") {
            return Some(
                val.into_iter()
    ...
    pub fn verification_type(&self) -> Option<CodeableConcept> {
        if let Some(val) = self.value.get("verificationType") {
    ...
    pub fn verified_by(&self) -> Option<Reference> {
        if let Some(val) = self.value.get("verifiedBy") {
    ...
    pub fn validate(&self) -> bool {
        ...
        if let Some(_val) = self.verification_type() {
            if !_val.validate() {
                return false;
            }
        }
        if let Some(_val) = self.verified() {}
        if let Some(_val) = self.verified_by() {
            if !_val.validate() {
                return false;
            }
        }
...
impl Consent_VerificationBuilder {
    ...
    pub fn verification_type<'a>(
        &'a mut self,
        val: CodeableConcept,
    ) -> &'a mut Consent_VerificationBuilder {
        self.value["verificationType"] = json!(val.value);
        return self;
    }
    ...
    pub fn verified_by<'a>(&'a mut self, val: Reference) -> &'a mut Consent_VerificationBuilder {
        self.value["verifiedBy"] = json!(val.value);
        return self;
    }
