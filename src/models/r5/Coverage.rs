...
use crate::models::r5::Coverage_Class::Coverage_Class;
use crate::models::r5::Coverage_CostToBeneficiary::Coverage_CostToBeneficiary;
...
impl Coverage<'_> {
    ...
    /// The party who benefits from the insurance coverage; the patient when products and/
    ...
    /// currently in force. Note, there may be gaps in the numbering and this does not
    /// imply primary, secondary etc. as the specific positioning of coverages depends
    ...
    /// policy or to whom the benefit of the policy for services rendered to them or their
    /// family is due.
    ...
    pub fn subscriber_id(&self) -> Option<Identifier> {
        if let Some(val) = self.value.get("subscriberId") {
...
impl CoverageBuilder {
    ...
    pub fn subscriber_id<'a>(&'a mut self, val: Identifier) -> &'a mut CoverageBuilder {
        self.value["subscriberId"] = json!(val.value);
        return self;
    }
