...
impl DataRequirement_Sort<'_> {
    ...
    /// the required data. The path is allowed to contain qualifiers (.) to traverse sub-
    /// elements, as well as indexers ([x]) to traverse multiple-cardinality sub-elements.
