...
impl DeviceDefinition<'_> {
    ...
    pub fn _production_identifier_in_udi(&self) -> Option<Vec<Element>> {
    ...
    /// other organizations or owners. For example: handle ID. The identifier is typically
    /// valued if the udiDeviceIdentifier, partNumber or modelNumber is not valued and
    /// represents a different type of identifier.  However, it is permissible to still
    /// include those identifiers in DeviceDefinition.identifier with the appropriate
    /// identifier.type.
    ...
    pub fn production_identifier_in_udi(&self) -> Option<Vec<&str>> {
    ...
    /// The potential, valid configuration settings of a device, e.g., regulation status,
    /// time properties.
    ...
    pub fn validate(&self) -> bool {
        ...
        if let Some(_val) = self._production_identifier_in_udi() {
        ...
        if let Some(_val) = self.production_identifier_in_udi() {
...
impl DeviceDefinitionBuilder {
    ...
    pub fn _production_identifier_in_udi<'a>(
        &'a mut self,
        val: Vec<Element>,
    ...
    pub fn production_identifier_in_udi<'a>(
        &'a mut self,
        val: Vec<&str>,
    ) -> &'a mut DeviceDefinitionBuilder {
