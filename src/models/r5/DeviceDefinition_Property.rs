...
impl DeviceDefinition_PropertyBuilder {
    ...
    pub fn value_boolean<'a>(&'a mut self, val: bool) -> &'a mut DeviceDefinition_PropertyBuilder {
    ...
    pub fn value_integer<'a>(&'a mut self, val: f64) -> &'a mut DeviceDefinition_PropertyBuilder {
    ...
    pub fn value_range<'a>(&'a mut self, val: Range) -> &'a mut DeviceDefinition_PropertyBuilder {
        self.value["valueRange"] = json!(val.value);
        return self;
    }

    pub fn value_string<'a>(&'a mut self, val: &str) -> &'a mut DeviceDefinition_PropertyBuilder {
