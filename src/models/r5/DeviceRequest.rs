...
use crate::models::r5::DeviceRequest_Parameter::DeviceRequest_Parameter;
...
impl DeviceRequest<'_> {
    ...
    /// hour before breakfast for 10 days from 23-Dec 2011:"; "15 Oct 2013, 17 Oct 2013
    /// and 1 Nov 2013".
    ...
    /// The desired kind of individual or entity to provide the device to the subject of
...
impl DeviceRequestBuilder {
    ...
    pub fn new(code: CodeableReference, subject: Reference) -> DeviceRequestBuilder {
    ...
    pub fn _do_not_perform<'a>(&'a mut self, val: Element) -> &'a mut DeviceRequestBuilder {
    ...
    pub fn _quantity<'a>(&'a mut self, val: Element) -> &'a mut DeviceRequestBuilder {
    ...
    pub fn do_not_perform<'a>(&'a mut self, val: bool) -> &'a mut DeviceRequestBuilder {
    ...
    pub fn quantity<'a>(&'a mut self, val: i64) -> &'a mut DeviceRequestBuilder {
        self.value["quantity"] = json!(val);
        return self;
    }

    pub fn reason<'a>(&'a mut self, val: Vec<CodeableReference>) -> &'a mut DeviceRequestBuilder {
