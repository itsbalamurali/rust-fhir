...
impl Device_DeviceName<'_> {
    ...
    /// The type of deviceName. Note that ManufactureDeviceName means that the name
    /// is the name as given by the manufacturer, not the name of the manufacturer.
...
impl Device_DeviceNameBuilder {
    ...
    pub fn fhir_type<'a>(&'a mut self, val: &str) -> &'a mut Device_DeviceNameBuilder {
