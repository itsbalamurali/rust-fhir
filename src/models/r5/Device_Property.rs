...
impl Device_Property<'_> {
    ...
    /// Code that specifies the property being represented. No codes are specified but the
    /// MDC codes are an example: https://build.fhir.org/mdc.html.
...
impl Device_PropertyBuilder {
    ...
    pub fn _value_boolean<'a>(&'a mut self, val: Element) -> &'a mut Device_PropertyBuilder {
        self.value["_valueBoolean"] = json!(val.value);
        return self;
    }

    pub fn _value_integer<'a>(&'a mut self, val: Element) -> &'a mut Device_PropertyBuilder {
        self.value["_valueInteger"] = json!(val.value);
        return self;
    }

    pub fn _value_string<'a>(&'a mut self, val: Element) -> &'a mut Device_PropertyBuilder {
    ...
    pub fn value_attachment<'a>(&'a mut self, val: Attachment) -> &'a mut Device_PropertyBuilder {
        self.value["valueAttachment"] = json!(val.value);
        return self;
    }

    pub fn value_boolean<'a>(&'a mut self, val: bool) -> &'a mut Device_PropertyBuilder {
    ...
    pub fn value_integer<'a>(&'a mut self, val: f64) -> &'a mut Device_PropertyBuilder {
        self.value["valueInteger"] = json!(val);
        return self;
    }

    pub fn value_quantity<'a>(&'a mut self, val: Quantity) -> &'a mut Device_PropertyBuilder {
        self.value["valueQuantity"] = json!(val.value);
        return self;
    }

    pub fn value_range<'a>(&'a mut self, val: Range) -> &'a mut Device_PropertyBuilder {
        self.value["valueRange"] = json!(val.value);
        return self;
    }

    pub fn value_string<'a>(&'a mut self, val: &str) -> &'a mut Device_PropertyBuilder {
