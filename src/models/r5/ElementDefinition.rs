...
use crate::models::r5::Address::Address;
...
use crate::models::r5::Contributor::Contributor;
use crate::models::r5::Count::Count;
use crate::models::r5::DataRequirement::DataRequirement;
use crate::models::r5::Distance::Distance;
use crate::models::r5::Dosage::Dosage;
use crate::models::r5::Duration::Duration;
use crate::models::r5::Element::Element;
use crate::models::r5::ElementDefinition_Base::ElementDefinition_Base;
use crate::models::r5::ElementDefinition_Binding::ElementDefinition_Binding;
use crate::models::r5::ElementDefinition_Constraint::ElementDefinition_Constraint;
use crate::models::r5::ElementDefinition_Example::ElementDefinition_Example;
use crate::models::r5::ElementDefinition_Mapping::ElementDefinition_Mapping;
use crate::models::r5::ElementDefinition_Slicing::ElementDefinition_Slicing;
use crate::models::r5::ElementDefinition_Type::ElementDefinition_Type;
use crate::models::r5::Expression::Expression;
use crate::models::r5::Extension::Extension;
use crate::models::r5::HumanName::HumanName;
use crate::models::r5::Identifier::Identifier;
use crate::models::r5::Meta::Meta;
use crate::models::r5::Money::Money;
use crate::models::r5::ParameterDefinition::ParameterDefinition;
...
use crate::models::r5::Signature::Signature;
...
impl ElementDefinition<'_> {
    ...
    pub fn _default_value_integer_64(&self) -> Option<Element> {
        if let Some(val) = self.value.get("_defaultValueInteger64") {
            return Some(Element {
                value: Cow::Borrowed(val),
            });
        }
    ...
    pub fn _fixed_integer_64(&self) -> Option<Element> {
        if let Some(val) = self.value.get("_fixedInteger64") {
            return Some(Element {
                value: Cow::Borrowed(val),
            });
        }
    ...
    pub fn _max_value_integer_64(&self) -> Option<Element> {
        if let Some(val) = self.value.get("_maxValueInteger64") {
            return Some(Element {
                value: Cow::Borrowed(val),
            });
        }
    ...
    pub fn _min_value_integer_64(&self) -> Option<Element> {
        if let Some(val) = self.value.get("_minValueInteger64") {
            return Some(Element {
                value: Cow::Borrowed(val),
            });
        }
    ...
    pub fn _pattern_integer_64(&self) -> Option<Element> {
        if let Some(val) = self.value.get("_patternInteger64") {
            return Some(Element {
                value: Cow::Borrowed(val),
            });
        }
    ...
    /// The value that should be used if there is no value stated in the instance (e.g.
    /// 'if not otherwise specified, the abstract is false').
    pub fn default_value_codeable_reference(&self) -> Option<CodeableReference> {
        if let Some(val) = self.value.get("defaultValueCodeableReference") {
    ...
    /// The value that should be used if there is no value stated in the instance (e.g.
    /// 'if not otherwise specified, the abstract is false').
    pub fn default_value_integer_64(&self) -> Option<&str> {
        if let Some(Value::String(string)) = self.value.get("defaultValueInteger64") {
            return Some(string);
        }
        return None;
    }
    ...
    /// The value that should be used if there is no value stated in the instance (e.g.
    /// 'if not otherwise specified, the abstract is false').
    pub fn default_value_ratio_range(&self) -> Option<RatioRange> {
        if let Some(val) = self.value.get("defaultValueRatioRange") {
    ...
    /// all values must be an exact match (case and accent sensitive). Missing elements/
    /// attributes must also be missing.
    pub fn fixed_integer_64(&self) -> Option<&str> {
        if let Some(Value::String(string)) = self.value.get("fixedInteger64") {
            return Some(string);
        }
        return None;
    }
    ...
    /// The maximum allowed value for the element. The value is inclusive. This is allowed
    /// for the types date, dateTime, instant, time, decimal, integer, and Quantity.
    pub fn max_value_integer_64(&self) -> Option<&str> {
        if let Some(Value::String(string)) = self.value.get("maxValueInteger64") {
            return Some(string);
        }
        return None;
    }
    ...
    /// The minimum allowed value for the element. The value is inclusive. This is allowed
    /// for the types date, dateTime, instant, time, decimal, integer, and Quantity.
    pub fn min_value_integer_64(&self) -> Option<&str> {
        if let Some(Value::String(string)) = self.value.get("minValueInteger64") {
            return Some(string);
        }
        return None;
    }
    ...
    /// a complex object: it must match (recursively) the pattern value  3. If an array:
    /// it must match (recursively) the pattern value.
    pub fn pattern_integer_64(&self) -> Option<&str> {
        if let Some(Value::String(string)) = self.value.get("patternInteger64") {
            return Some(string);
        }
        return None;
    }
    ...
    pub fn validate(&self) -> bool {
        ...
        if let Some(_val) = self._default_value_integer_64() {
            if !_val.validate() {
                return false;
            }
        }
        ...
        if let Some(_val) = self._fixed_integer_64() {
            if !_val.validate() {
                return false;
            }
        }
        ...
        if let Some(_val) = self._max_value_integer_64() {
            if !_val.validate() {
                return false;
            }
        }
        ...
        if let Some(_val) = self._min_value_integer_64() {
            if !_val.validate() {
                return false;
            }
        }
        ...
        if let Some(_val) = self._pattern_integer_64() {
            if !_val.validate() {
                return false;
            }
        }
        ...
        if let Some(_val) = self.default_value_codeable_reference() {
            if !_val.validate() {
                return false;
            }
        }
        ...
        if let Some(_val) = self.default_value_integer_64() {}
        ...
        if let Some(_val) = self.default_value_ratio_range() {
            if !_val.validate() {
                return false;
            }
        }
        ...
        if let Some(_val) = self.fixed_codeable_reference() {
            if !_val.validate() {
                return false;
            }
        }
        ...
        if let Some(_val) = self.fixed_integer_64() {}
        ...
        if let Some(_val) = self.fixed_ratio_range() {
            if !_val.validate() {
                return false;
            }
        }
        ...
        if let Some(_val) = self.max_value_integer_64() {}
        ...
        if let Some(_val) = self.min_value_integer_64() {}
        ...
        if let Some(_val) = self.pattern_codeable_reference() {
            if !_val.validate() {
                return false;
            }
        }
        ...
        if let Some(_val) = self.pattern_integer_64() {}
        ...
        if let Some(_val) = self.pattern_ratio_range() {
            if !_val.validate() {
                return false;
            }
        }
...
impl ElementDefinitionBuilder {
    ...
    pub fn _default_value_integer_64<'a>(
        &'a mut self,
        val: Element,
    ) -> &'a mut ElementDefinitionBuilder {
        self.value["_defaultValueInteger64"] = json!(val.value);
        return self;
    }
    ...
    pub fn _fixed_integer_64<'a>(&'a mut self, val: Element) -> &'a mut ElementDefinitionBuilder {
        self.value["_fixedInteger64"] = json!(val.value);
        return self;
    }
    ...
    pub fn _max_value_integer_64<'a>(
        &'a mut self,
        val: Element,
    ) -> &'a mut ElementDefinitionBuilder {
        self.value["_maxValueInteger64"] = json!(val.value);
        return self;
    }
    ...
    pub fn _min_value_integer_64<'a>(
        &'a mut self,
        val: Element,
    ) -> &'a mut ElementDefinitionBuilder {
        self.value["_minValueInteger64"] = json!(val.value);
        return self;
    }
    ...
    pub fn _pattern_integer_64<'a>(&'a mut self, val: Element) -> &'a mut ElementDefinitionBuilder {
        self.value["_patternInteger64"] = json!(val.value);
        return self;
    }
    ...
    pub fn default_value_codeable_reference<'a>(
        &'a mut self,
        val: CodeableReference,
    ) -> &'a mut ElementDefinitionBuilder {
        self.value["defaultValueCodeableReference"] = json!(val.value);
        return self;
    }
    ...
    pub fn default_value_integer_64<'a>(
        &'a mut self,
        val: &str,
    ) -> &'a mut ElementDefinitionBuilder {
        self.value["defaultValueInteger64"] = json!(val);
        return self;
    }
    ...
    pub fn default_value_ratio_range<'a>(
        &'a mut self,
        val: RatioRange,
    ) -> &'a mut ElementDefinitionBuilder {
        self.value["defaultValueRatioRange"] = json!(val.value);
        return self;
    }
    ...
    pub fn fixed_codeable_reference<'a>(
        &'a mut self,
        val: CodeableReference,
    ) -> &'a mut ElementDefinitionBuilder {
        self.value["fixedCodeableReference"] = json!(val.value);
        return self;
    }
    ...
    pub fn fixed_integer_64<'a>(&'a mut self, val: &str) -> &'a mut ElementDefinitionBuilder {
        self.value["fixedInteger64"] = json!(val);
        return self;
    }
    ...
    pub fn fixed_ratio_range<'a>(
        &'a mut self,
        val: RatioRange,
    ) -> &'a mut ElementDefinitionBuilder {
        self.value["fixedRatioRange"] = json!(val.value);
        return self;
    }
    ...
    pub fn max_value_integer_64<'a>(&'a mut self, val: &str) -> &'a mut ElementDefinitionBuilder {
        self.value["maxValueInteger64"] = json!(val);
        return self;
    }
    ...
    pub fn min_value_integer_64<'a>(&'a mut self, val: &str) -> &'a mut ElementDefinitionBuilder {
        self.value["minValueInteger64"] = json!(val);
        return self;
    }
    ...
    pub fn pattern_codeable_reference<'a>(
        &'a mut self,
        val: CodeableReference,
    ) -> &'a mut ElementDefinitionBuilder {
        self.value["patternCodeableReference"] = json!(val.value);
        return self;
    }
    ...
    pub fn pattern_integer_64<'a>(&'a mut self, val: &str) -> &'a mut ElementDefinitionBuilder {
        self.value["patternInteger64"] = json!(val);
        return self;
    }
    ...
    pub fn pattern_ratio_range<'a>(
        &'a mut self,
        val: RatioRange,
    ) -> &'a mut ElementDefinitionBuilder {
        self.value["patternRatioRange"] = json!(val.value);
        return self;
    }
