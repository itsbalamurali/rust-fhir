...
use crate::models::r5::EvidenceReport_RelatesTo::EvidenceReport_RelatesTo;
use crate::models::r5::EvidenceReport_Section::EvidenceReport_Section;
use crate::models::r5::EvidenceReport_Subject::EvidenceReport_Subject;
...
impl EvidenceReport<'_> {
    ...
    /// The date  (and optionally time) when the {{title}} was published. The date
    ...
    /// An absolute URI that is used to identify this EvidenceReport when it is referenced
    ...
    /// assist with indexing and searching for appropriate evidence report instances.
...
impl EvidenceReportBuilder {
    ...
    pub fn _approval_date<'a>(&'a mut self, val: Element) -> &'a mut EvidenceReportBuilder {
    ...
    pub fn _copyright<'a>(&'a mut self, val: Element) -> &'a mut EvidenceReportBuilder {
        self.value["_copyright"] = json!(val.value);
        return self;
    }

    pub fn _date<'a>(&'a mut self, val: Element) -> &'a mut EvidenceReportBuilder {
        self.value["_date"] = json!(val.value);
        return self;
    }

    pub fn _description<'a>(&'a mut self, val: Element) -> &'a mut EvidenceReportBuilder {
        self.value["_description"] = json!(val.value);
        return self;
    }

    pub fn _experimental<'a>(&'a mut self, val: Element) -> &'a mut EvidenceReportBuilder {
    ...
    pub fn _last_review_date<'a>(&'a mut self, val: Element) -> &'a mut EvidenceReportBuilder {
        self.value["_lastReviewDate"] = json!(val.value);
        return self;
    }

    pub fn _name<'a>(&'a mut self, val: Element) -> &'a mut EvidenceReportBuilder {
    ...
    pub fn _purpose<'a>(&'a mut self, val: Element) -> &'a mut EvidenceReportBuilder {
    ...
    pub fn _title<'a>(&'a mut self, val: Element) -> &'a mut EvidenceReportBuilder {
    ...
    pub fn _version<'a>(&'a mut self, val: Element) -> &'a mut EvidenceReportBuilder {
        self.value["_version"] = json!(val.value);
        return self;
    }

    pub fn approval_date<'a>(&'a mut self, val: &str) -> &'a mut EvidenceReportBuilder {
    ...
    pub fn copyright<'a>(&'a mut self, val: &str) -> &'a mut EvidenceReportBuilder {
        self.value["copyright"] = json!(val);
        return self;
    }

    pub fn date<'a>(&'a mut self, val: &str) -> &'a mut EvidenceReportBuilder {
        self.value["date"] = json!(val);
        return self;
    }

    pub fn description<'a>(&'a mut self, val: &str) -> &'a mut EvidenceReportBuilder {
    ...
    pub fn effective_period<'a>(&'a mut self, val: Period) -> &'a mut EvidenceReportBuilder {
    ...
    pub fn experimental<'a>(&'a mut self, val: bool) -> &'a mut EvidenceReportBuilder {
    ...
    pub fn last_review_date<'a>(&'a mut self, val: &str) -> &'a mut EvidenceReportBuilder {
    ...
    pub fn name<'a>(&'a mut self, val: &str) -> &'a mut EvidenceReportBuilder {
    ...
    pub fn purpose<'a>(&'a mut self, val: &str) -> &'a mut EvidenceReportBuilder {
    ...
    pub fn title<'a>(&'a mut self, val: &str) -> &'a mut EvidenceReportBuilder {
        self.value["title"] = json!(val);
        return self;
    }

    pub fn topic<'a>(&'a mut self, val: Vec<CodeableConcept>) -> &'a mut EvidenceReportBuilder {
    ...
    pub fn version<'a>(&'a mut self, val: &str) -> &'a mut EvidenceReportBuilder {
