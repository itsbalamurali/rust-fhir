...
use crate::models::r5::EvidenceReport_Target::EvidenceReport_Target;
...
impl EvidenceReport_RelatesTo<'_> {
    ...
    pub fn target(&self) -> EvidenceReport_Target {
...
impl EvidenceReport_RelatesToBuilder {
    ...
    pub fn new(target: EvidenceReport_Target) -> EvidenceReport_RelatesToBuilder {
