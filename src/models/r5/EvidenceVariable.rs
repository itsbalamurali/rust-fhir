...
use crate::models::r5::EvidenceVariable_Category::EvidenceVariable_Category;
use crate::models::r5::EvidenceVariable_Characteristic::EvidenceVariable_Characteristic;
use crate::models::r5::EvidenceVariable_CharacteristicCombination::EvidenceVariable_CharacteristicCombination;
...
impl EvidenceVariable<'_> {
    ...
    /// True if the actual variable measured, false if a conceptual representation of the
    /// intended variable.
    ...
    pub fn category(&self) -> Option<Vec<EvidenceVariable_Category>> {
        if let Some(Value::Array(val)) = self.value.get("category") {
            return Some(
                val.into_iter()
                    .map(|e| EvidenceVariable_Category {
                        value: Cow::Borrowed(e),
                    })
                    .collect::<Vec<_>>(),
            );
    ...
    pub fn characteristic(&self) -> Option<Vec<EvidenceVariable_Characteristic>> {
    ...
    pub fn characteristic_combination(&self) -> Option<EvidenceVariable_CharacteristicCombination> {
        if let Some(val) = self.value.get("characteristicCombination") {
            return Some(EvidenceVariable_CharacteristicCombination {
                value: Cow::Borrowed(val),
            });
        }
        return None;
    ...
    pub fn validate(&self) -> bool {
        ...
        if let Some(_val) = self.characteristic_combination() {
            if !_val.validate() {
                return false;
            }
        }
...
impl EvidenceVariableBuilder {
    ...
    pub fn new() -> EvidenceVariableBuilder {
        let mut __value: Value = json!({});
        return EvidenceVariableBuilder { value: __value };
    }

    pub fn _actual<'a>(&'a mut self, val: Element) -> &'a mut EvidenceVariableBuilder {
    ...
    pub fn _experimental<'a>(&'a mut self, val: Element) -> &'a mut EvidenceVariableBuilder {
        self.value["_experimental"] = json!(val.value);
        return self;
    }

    pub fn _handling<'a>(&'a mut self, val: Element) -> &'a mut EvidenceVariableBuilder {
    ...
    pub fn _purpose<'a>(&'a mut self, val: Element) -> &'a mut EvidenceVariableBuilder {
    ...
    pub fn actual<'a>(&'a mut self, val: bool) -> &'a mut EvidenceVariableBuilder {
    ...
    pub fn category<'a>(
        &'a mut self,
        val: Vec<EvidenceVariable_Category>,
    ...
    pub fn characteristic<'a>(
        &'a mut self,
        val: Vec<EvidenceVariable_Characteristic>,
    ) -> &'a mut EvidenceVariableBuilder {
        self.value["characteristic"] = json!(val.into_iter().map(|e| e.value).collect::<Vec<_>>());
        return self;
    }

    pub fn characteristic_combination<'a>(
        &'a mut self,
        val: EvidenceVariable_CharacteristicCombination,
    ) -> &'a mut EvidenceVariableBuilder {
        self.value["characteristicCombination"] = json!(val.value);
        return self;
    }
    ...
    pub fn experimental<'a>(&'a mut self, val: bool) -> &'a mut EvidenceVariableBuilder {
    ...
    pub fn handling<'a>(&'a mut self, val: &str) -> &'a mut EvidenceVariableBuilder {
    ...
    pub fn purpose<'a>(&'a mut self, val: &str) -> &'a mut EvidenceVariableBuilder {
    ...
    pub fn status<'a>(&'a mut self, val: &str) -> &'a mut EvidenceVariableBuilder {
