...
use crate::models::r5::ExampleScenario_Actor::ExampleScenario_Actor;
use crate::models::r5::ExampleScenario_Instance::ExampleScenario_Instance;
use crate::models::r5::ExampleScenario_Process::ExampleScenario_Process;
...
impl ExampleScenarioBuilder {
    ...
    pub fn _description<'a>(&'a mut self, val: Element) -> &'a mut ExampleScenarioBuilder {
    ...
    pub fn _title<'a>(&'a mut self, val: Element) -> &'a mut ExampleScenarioBuilder {
    ...
    pub fn description<'a>(&'a mut self, val: &str) -> &'a mut ExampleScenarioBuilder {
    ...
    pub fn status<'a>(&'a mut self, val: &str) -> &'a mut ExampleScenarioBuilder {
    ...
    pub fn title<'a>(&'a mut self, val: &str) -> &'a mut ExampleScenarioBuilder {
