...
impl ExtensionBuilder {
    ...
    pub fn _value_integer_6_4<'a>(&'a mut self, val: Element) -> &'a mut ExtensionBuilder {
    ...
    pub fn value_integer_6_4<'a>(&'a mut self, val: &str) -> &'a mut ExtensionBuilder {
    ...
    pub fn value_ratio_range<'a>(&'a mut self, val: RatioRange) -> &'a mut ExtensionBuilder {
