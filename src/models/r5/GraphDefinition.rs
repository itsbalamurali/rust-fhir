...
use crate::models::r5::GraphDefinition_Link::GraphDefinition_Link;
...
impl GraphDefinitionBuilder {
    ...
    pub fn _copyright<'a>(&'a mut self, val: Element) -> &'a mut GraphDefinitionBuilder {
    ...
    pub fn _title<'a>(&'a mut self, val: Element) -> &'a mut GraphDefinitionBuilder {
    ...
    pub fn copyright<'a>(&'a mut self, val: &str) -> &'a mut GraphDefinitionBuilder {
    ...
    pub fn identifier<'a>(&'a mut self, val: Vec<Identifier>) -> &'a mut GraphDefinitionBuilder {
    ...
    pub fn title<'a>(&'a mut self, val: &str) -> &'a mut GraphDefinitionBuilder {
