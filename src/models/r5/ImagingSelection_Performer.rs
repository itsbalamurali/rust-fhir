...
#[derive(Debug)]
pub struct ImagingSelection_Performer<'a> {
    pub(crate) value: Cow<'a, Value>,
}

impl ImagingSelection_Performer<'_> {
    pub fn new(value: &Value) -> ImagingSelection_Performer {
...
#[derive(Debug)]
pub struct ImagingSelection_PerformerBuilder {
    pub(crate) value: Value,
}

impl ImagingSelection_PerformerBuilder {
    pub fn build(&self) -> ImagingSelection_Performer {
        ImagingSelection_Performer {
            value: Cow::Owned(self.value.clone()),
        }
    }

    pub fn with(existing: ImagingSelection_Performer) -> ImagingSelection_PerformerBuilder {
        ImagingSelection_PerformerBuilder {
            value: (*existing.value).clone(),
        }
    }

    pub fn new() -> ImagingSelection_PerformerBuilder {
        let mut __value: Value = json!({});
        return ImagingSelection_PerformerBuilder { value: __value };
    }

    pub fn actor<'a>(&'a mut self, val: Reference) -> &'a mut ImagingSelection_PerformerBuilder {
    ...
    pub fn extension<'a>(
        &'a mut self,
        val: Vec<Extension>,
    ) -> &'a mut ImagingSelection_PerformerBuilder {
    ...
    pub fn id<'a>(&'a mut self, val: &str) -> &'a mut ImagingSelection_PerformerBuilder {
