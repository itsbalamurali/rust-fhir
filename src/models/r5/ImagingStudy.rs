...
use crate::models::r5::ImagingStudy_Series::ImagingStudy_Series;
...
impl ImagingStudy<'_> {
    ...
    pub fn procedure(&self) -> Option<Vec<CodeableReference>> {
...
impl ImagingStudyBuilder {
    ...
    pub fn procedure<'a>(&'a mut self, val: Vec<CodeableReference>) -> &'a mut ImagingStudyBuilder {
        self.value["procedure"] = json!(val.into_iter().map(|e| e.value).collect::<Vec<_>>());
        return self;
    }

    pub fn reason<'a>(&'a mut self, val: Vec<CodeableReference>) -> &'a mut ImagingStudyBuilder {
    ...
    pub fn status<'a>(&'a mut self, val: &str) -> &'a mut ImagingStudyBuilder {
