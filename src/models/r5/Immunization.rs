...
use crate::models::r5::Immunization_Education::Immunization_Education;
use crate::models::r5::Immunization_Performer::Immunization_Performer;
use crate::models::r5::Immunization_ProtocolApplied::Immunization_ProtocolApplied;
use crate::models::r5::Immunization_Reaction::Immunization_Reaction;
...
impl Immunization<'_> {
    ...
    /// Typically the source of the data when the report of the immunization event is not
    /// based on information from the person who administered the vaccine.
    pub fn information_source_codeable_concept(&self) -> Option<CodeableConcept> {
        if let Some(val) = self.value.get("informationSourceCodeableConcept") {
            return Some(CodeableConcept {
                value: Cow::Borrowed(val),
            });
        }
    ...
    /// Typically the source of the data when the report of the immunization event is not
    /// based on information from the person who administered the vaccine.
    pub fn information_source_reference(&self) -> Option<Reference> {
        if let Some(val) = self.value.get("informationSourceReference") {
            return Some(Reference {
                value: Cow::Borrowed(val),
            });
        }
    ...
    /// definition that is adhered to in whole or in part by this Immunization.
    ...
    /// other definition that is adhered to in whole or in part by this Immunization.
    ...
    pub fn validate(&self) -> bool {
        ...
        if let Some(_val) = self.information_source_codeable_concept() {
            if !_val.validate() {
                return false;
            }
        }
        if let Some(_val) = self.information_source_reference() {
            if !_val.validate() {
                return false;
            }
        }
...
impl ImmunizationBuilder {
    ...
    pub fn _instantiates_uri<'a>(&'a mut self, val: Vec<Element>) -> &'a mut ImmunizationBuilder {
    ...
    pub fn based_on<'a>(&'a mut self, val: Vec<Reference>) -> &'a mut ImmunizationBuilder {
    ...
    pub fn information_source_codeable_concept<'a>(
        &'a mut self,
        val: CodeableConcept,
    ) -> &'a mut ImmunizationBuilder {
        self.value["informationSourceCodeableConcept"] = json!(val.value);
        return self;
    }

    pub fn information_source_reference<'a>(
        &'a mut self,
        val: Reference,
    ) -> &'a mut ImmunizationBuilder {
        self.value["informationSourceReference"] = json!(val.value);
        return self;
    }

    pub fn instantiates_canonical<'a>(&'a mut self, val: Vec<&str>) -> &'a mut ImmunizationBuilder {
        self.value["instantiatesCanonical"] = json!(val);
        return self;
    }

    pub fn instantiates_uri<'a>(&'a mut self, val: Vec<&str>) -> &'a mut ImmunizationBuilder {
    ...
    pub fn reason<'a>(&'a mut self, val: Vec<CodeableReference>) -> &'a mut ImmunizationBuilder {
