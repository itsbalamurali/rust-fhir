...
use crate::models::r5::ImmunizationRecommendation_Recommendation::ImmunizationRecommendation_Recommendation;
...
impl ImmunizationRecommendation<'_> {
    ...
    /// The URL pointing to a FHIR-defined protocol, guideline or other definition that
    /// is adhered to in whole or in part by this ImmunizationRecommendation.
    ...
    /// The URL pointing to an externally maintained protocol, guideline or other
