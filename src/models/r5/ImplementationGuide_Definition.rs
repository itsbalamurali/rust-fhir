...
use crate::models::r5::ImplementationGuide_Grouping::ImplementationGuide_Grouping;
use crate::models::r5::ImplementationGuide_Page::ImplementationGuide_Page;
use crate::models::r5::ImplementationGuide_Parameter::ImplementationGuide_Parameter;
use crate::models::r5::ImplementationGuide_Resource::ImplementationGuide_Resource;
use crate::models::r5::ImplementationGuide_Template::ImplementationGuide_Template;
use serde_json::json;
...
impl ImplementationGuide_Definition<'_> {
    ...
    /// parameters are defined by the relevant tools that build the implementation guides.
