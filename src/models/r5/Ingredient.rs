...
use crate::models::r5::Ingredient_Manufacturer::Ingredient_Manufacturer;
use crate::models::r5::Ingredient_Substance::Ingredient_Substance;
...
impl Ingredient<'_> {
    ...
    pub fn group(&self) -> Option<CodeableConcept> {
    ...
    /// The identifier(s) of this Ingredient that are assigned by business processes and/
    /// or used to refer to it when a direct URL reference to the resource itself is not
    /// appropriate.
...
impl IngredientBuilder {
    ...
    pub fn group<'a>(&'a mut self, val: CodeableConcept) -> &'a mut IngredientBuilder {
        self.value["group"] = json!(val.value);
        return self;
    }
