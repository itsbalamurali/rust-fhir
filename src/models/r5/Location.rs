...
use crate::models::r5::Location_HoursOfOperation::Location_HoursOfOperation;
use crate::models::r5::Location_Position::Location_Position;
...
impl Location<'_> {
    ...
    /// current value which may be covered by the operationStatus, or by a schedule/slots
...
impl LocationBuilder {
    ...
    pub fn mode<'a>(&'a mut self, val: &str) -> &'a mut LocationBuilder {
    ...
    pub fn status<'a>(&'a mut self, val: &str) -> &'a mut LocationBuilder {
