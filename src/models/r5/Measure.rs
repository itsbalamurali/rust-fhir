...
use crate::models::r5::Measure_Group::Measure_Group;
use crate::models::r5::Measure_SupplementalData::Measure_SupplementalData;
...
impl Measure<'_> {
    ...
    /// changes. In addition, it should change when the substantive content of the measure
    /// changes.
    ...
    /// an authoritative instance of this measure is (or will be) published. This URL can
    /// be the target of a canonical reference. It SHALL remain the same when the measure
...
impl MeasureBuilder {
    ...
    pub fn _basis<'a>(&'a mut self, val: Element) -> &'a mut MeasureBuilder {
    ...
    pub fn basis<'a>(&'a mut self, val: &str) -> &'a mut MeasureBuilder {
    ...
    pub fn scoring_unit<'a>(&'a mut self, val: CodeableConcept) -> &'a mut MeasureBuilder {
        self.value["scoringUnit"] = json!(val.value);
        return self;
    }

    pub fn status<'a>(&'a mut self, val: &str) -> &'a mut MeasureBuilder {
