...
impl MeasureReport_ComponentBuilder {
    ...
    pub fn new(code: CodeableConcept) -> MeasureReport_ComponentBuilder {
    ...
    pub fn value_boolean<'a>(&'a mut self, val: bool) -> &'a mut MeasureReport_ComponentBuilder {
    ...
    pub fn value_range<'a>(&'a mut self, val: Range) -> &'a mut MeasureReport_ComponentBuilder {
