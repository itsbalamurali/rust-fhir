...
use crate::models::r5::MeasureReport_Population::MeasureReport_Population;
use crate::models::r5::MeasureReport_Stratifier::MeasureReport_Stratifier;
...
impl MeasureReport_GroupBuilder {
    ...
    pub fn measure_score_range<'a>(&'a mut self, val: Range) -> &'a mut MeasureReport_GroupBuilder {
