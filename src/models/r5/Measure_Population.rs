...
impl Measure_Population<'_> {
    ...
    /// Specifies which method should be used to aggregate measure observation values. For
    /// most scoring types, this is implied by scoring (e.g. a proportion measure counts
    ...
    /// a proportion scoring). In some cases, however, multiple possible choices exist and
    /// must be resolved explicitly. For example in a ratio measure with multiple initial
