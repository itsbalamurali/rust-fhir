...
impl Medication<'_> {
    ...
    /// that has the same strength (For example, Insulin glargine 100 unit per mL solution
    /// for injection), this attribute provides additional clarification of the package
