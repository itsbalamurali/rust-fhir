...
use crate::models::r5::MedicationAdministration_Dosage::MedicationAdministration_Dosage;
use crate::models::r5::MedicationAdministration_Performer::MedicationAdministration_Performer;
...
impl MedicationAdministration<'_> {
    ...
    pub fn _occurence_date_time(&self) -> Option<Element> {
        if let Some(val) = self.value.get("_occurenceDateTime") {
            return Some(Element {
                value: Cow::Borrowed(val),
            });
        }
    ...
    /// The type of medication administration (for example, drug classification like ATC,
    ...
    /// resource representing the details of the medication or a simple attribute carrying
    ...
    pub fn occurence_date_time(&self) -> Option<&str> {
        if let Some(Value::String(string)) = self.value.get("occurenceDateTime") {
            return Some(string);
        }
        return None;
    }
    ...
    /// place (or did not take place). For many administrations, such as swallowing a
    /// tablet the use of dateTime is more appropriate.
    pub fn occurence_period(&self) -> Option<Period> {
        if let Some(val) = self.value.get("occurencePeriod") {
            return Some(Period {
                value: Cow::Borrowed(val),
            });
        }
    ...
    /// The date the occurrence of the  MedicationAdministration was first captured in the
    ...
    pub fn validate(&self) -> bool {
        ...
        if let Some(_val) = self._occurence_date_time() {
            if !_val.validate() {
                return false;
            }
        }
        ...
        if let Some(_val) = self.occurence_date_time() {}
        if let Some(_val) = self.occurence_period() {
            if !_val.validate() {
                return false;
            }
        }
...
impl MedicationAdministrationBuilder {
    ...
    pub fn _occurence_date_time<'a>(
        &'a mut self,
        val: Element,
    ) -> &'a mut MedicationAdministrationBuilder {
        self.value["_occurenceDateTime"] = json!(val.value);
        return self;
    }

    pub fn _recorded<'a>(&'a mut self, val: Element) -> &'a mut MedicationAdministrationBuilder {
    ...
    pub fn encounter<'a>(&'a mut self, val: Reference) -> &'a mut MedicationAdministrationBuilder {
    ...
    pub fn occurence_date_time<'a>(
        &'a mut self,
        val: &str,
    ) -> &'a mut MedicationAdministrationBuilder {
        self.value["occurenceDateTime"] = json!(val);
        return self;
    }

    pub fn occurence_period<'a>(
        &'a mut self,
        val: Period,
    ) -> &'a mut MedicationAdministrationBuilder {
        self.value["occurencePeriod"] = json!(val.value);
        return self;
    }
    ...
    pub fn recorded<'a>(&'a mut self, val: &str) -> &'a mut MedicationAdministrationBuilder {
