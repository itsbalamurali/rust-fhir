...
use crate::models::r5::MedicationDispense_Performer::MedicationDispense_Performer;
use crate::models::r5::MedicationDispense_Substitution::MedicationDispense_Substitution;
...
impl MedicationDispense<'_> {
    ...
    /// substitution did or did not happen and why.  If nothing is specified, substitution
    /// was not done.
    ...
    /// Additional information that supports the medication being dispensed.  For example,
    /// there may be requirements that a specific lab test has been completed prior to
    /// dispensing or the patient's weight at the time of dispensing is documented.
...
impl MedicationDispenseBuilder {
    ...
    pub fn new(medication: CodeableReference, subject: Reference) -> MedicationDispenseBuilder {
    ...
    pub fn _recorded<'a>(&'a mut self, val: Element) -> &'a mut MedicationDispenseBuilder {
    ...
    pub fn _status_changed<'a>(&'a mut self, val: Element) -> &'a mut MedicationDispenseBuilder {
    ...
    pub fn based_on<'a>(&'a mut self, val: Vec<Reference>) -> &'a mut MedicationDispenseBuilder {
    ...
    pub fn encounter<'a>(&'a mut self, val: Reference) -> &'a mut MedicationDispenseBuilder {
    ...
    pub fn recorded<'a>(&'a mut self, val: &str) -> &'a mut MedicationDispenseBuilder {
    ...
    pub fn status_changed<'a>(&'a mut self, val: &str) -> &'a mut MedicationDispenseBuilder {
