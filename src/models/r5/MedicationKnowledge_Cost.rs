...
impl MedicationKnowledge_Cost<'_> {
    ...
    /// The price or representation of the cost (for example, Band A, Band B or $, $$) of
    /// the medication.
    pub fn cost_codeable_concept(&self) -> Option<CodeableConcept> {
        if let Some(val) = self.value.get("costCodeableConcept") {
    ...
    /// The price or representation of the cost (for example, Band A, Band B or $, $$) of
    /// the medication.
    pub fn cost_money(&self) -> Option<Money> {
        if let Some(val) = self.value.get("costMoney") {
            return Some(Money {
                value: Cow::Borrowed(val),
            });
        }
    ...
    pub fn effective_date(&self) -> Option<Vec<Period>> {
        if let Some(Value::Array(val)) = self.value.get("effectiveDate") {
            return Some(
                val.into_iter()
                    .map(|e| Period {
    ...
    pub fn validate(&self) -> bool {
        ...
        if let Some(_val) = self.cost_codeable_concept() {
            if !_val.validate() {
                return false;
            }
        }
        if let Some(_val) = self.cost_money() {
            if !_val.validate() {
                return false;
            }
        }
...
impl MedicationKnowledge_CostBuilder {
    ...
    pub fn new(fhir_type: CodeableConcept) -> MedicationKnowledge_CostBuilder {
    ...
    pub fn cost_codeable_concept<'a>(
        &'a mut self,
        val: CodeableConcept,
    ) -> &'a mut MedicationKnowledge_CostBuilder {
        self.value["costCodeableConcept"] = json!(val.value);
        return self;
    }

    pub fn cost_money<'a>(&'a mut self, val: Money) -> &'a mut MedicationKnowledge_CostBuilder {
        self.value["costMoney"] = json!(val.value);
        return self;
    }
    ...
    pub fn effective_date<'a>(
        ...
        self.value["effectiveDate"] = json!(val.into_iter().map(|e| e.value).collect::<Vec<_>>());
        return self;
    }
