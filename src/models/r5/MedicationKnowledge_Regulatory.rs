...
use crate::models::r5::MedicationKnowledge_MaxDispense::MedicationKnowledge_MaxDispense;
use crate::models::r5::MedicationKnowledge_Substitution::MedicationKnowledge_Substitution;
...
impl MedicationKnowledge_Regulatory<'_> {
    ...
    pub fn schedule(&self) -> Option<Vec<CodeableConcept>> {
