...
use crate::models::r5::MedicationRequest_DispenseRequest::MedicationRequest_DispenseRequest;
use crate::models::r5::MedicationRequest_Dose::MedicationRequest_Dose;
use crate::models::r5::MedicationRequest_Substitution::MedicationRequest_Substitution;
...
impl MedicationRequest<'_> {
    ...
    pub fn _status_changed(&self) -> Option<Element> {
        if let Some(val) = self.value.get("_statusChanged") {
            return Some(Element {
                value: Cow::Borrowed(val),
            });
        }
    ...
    /// Indicates the grouping or category of medication request (for example, drug
    ...
    /// The description of the overall pattern of the administration of the medication to
    /// the patient.
    ...
    /// Note that this information is not always sent with the order.  There may be in
    ...
    pub fn dose(&self) -> Option<MedicationRequest_Dose> {
        if let Some(val) = self.value.get("dose") {
            return Some(MedicationRequest_Dose {
                value: Cow::Borrowed(val),
            });
        }
        return None;
    ...
    /// request or event resources that identify key state transitions or updates that are
    /// likely to be relevant to a user looking at the current version of the resource.
    ...
    pub fn status_changed(&self) -> Option<&str> {
        if let Some(Value::String(string)) = self.value.get("statusChanged") {
            return Some(string);
        }
        return None;
    }
    ...
    /// some cases, substitution must happen, in other cases substitution must not happen.
    /// This block explains the prescriber's intent. If nothing is specified substitution
    /// may be done.
    ...
    /// medication, for example, patient height and weight, a MedicationUsage for the
    /// patient).
    ...
    pub fn validate(&self) -> bool {
        ...
        if let Some(_val) = self._status_changed() {
            if !_val.validate() {
                return false;
            }
        }
        ...
        if let Some(_val) = self.status_changed() {}
...
impl MedicationRequestBuilder {
    ...
    pub fn new(medication: CodeableReference, subject: Reference) -> MedicationRequestBuilder {
    ...
    pub fn _reported<'a>(&'a mut self, val: Element) -> &'a mut MedicationRequestBuilder {
    ...
    pub fn _status_changed<'a>(&'a mut self, val: Element) -> &'a mut MedicationRequestBuilder {
        self.value["_statusChanged"] = json!(val.value);
        return self;
    }
    ...
    pub fn dose<'a>(&'a mut self, val: MedicationRequest_Dose) -> &'a mut MedicationRequestBuilder {
    ...
    pub fn reported<'a>(&'a mut self, val: bool) -> &'a mut MedicationRequestBuilder {
    ...
    pub fn status_changed<'a>(&'a mut self, val: &str) -> &'a mut MedicationRequestBuilder {
        self.value["statusChanged"] = json!(val);
        return self;
    }
