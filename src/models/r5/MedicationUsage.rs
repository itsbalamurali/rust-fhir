...
impl MedicationUsage<'_> {
    ...
    /// this medication. Note: Use derivedFrom when a MedicationUsage is derived from
    ...
    /// Provides extra information about the Medication Usage that is not conveyed by
