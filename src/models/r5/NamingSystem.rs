...
impl NamingSystem<'_> {
    ...
    /// A natural language name identifying the naming system. This name should be usable
    ...
    /// An absolute URI that is used to identify this naming system when it is referenced
    /// in a specification, model, design or an instance; also called its canonical
    /// identifier. This SHOULD be globally unique and SHOULD be a literal address at
    /// which at which an authoritative instance of this naming system is (or will be)
    ...
    /// The identifier that is used to identify this version of the naming system when it
    /// is referenced in a specification, model, design or instance. This is an arbitrary
    /// value managed by the naming system author and is not expected to be globally
