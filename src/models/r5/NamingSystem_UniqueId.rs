...
impl NamingSystem_UniqueId<'_> {
    ...
    pub fn _authoritative(&self) -> Option<Element> {
        if let Some(val) = self.value.get("_authoritative") {
            return Some(Element {
    ...
    pub fn authoritative(&self) -> Option<bool> {
        if let Some(val) = self.value.get("authoritative") {
    ...
    pub fn validate(&self) -> bool {
        if let Some(_val) = self._authoritative() {
            if !_val.validate() {
                return false;
            }
        }
        ...
        if let Some(_val) = self.authoritative() {}
...
impl NamingSystem_UniqueIdBuilder {
    ...
    pub fn _authoritative<'a>(&'a mut self, val: Element) -> &'a mut NamingSystem_UniqueIdBuilder {
        self.value["_authoritative"] = json!(val.value);
        return self;
    }
    ...
    pub fn authoritative<'a>(&'a mut self, val: bool) -> &'a mut NamingSystem_UniqueIdBuilder {
        self.value["authoritative"] = json!(val);
        return self;
    }
    ...
    pub fn fhir_type<'a>(&'a mut self, val: &str) -> &'a mut NamingSystem_UniqueIdBuilder {
