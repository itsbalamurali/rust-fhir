...
impl NutritionIntake<'_> {
    ...
    /// Provides extra information about the Nutrition Intake that is not conveyed by the
    /// other attributes.
    ...
    /// The person or organization that provided the information about the consumption of
    /// this food or fluid. Note: Use derivedFrom when a NutritionIntake is derived from
    /// other resources.
    ...
    /// intake that this assertion is about.  Generally, this will be active or completed.
