...
impl ObservationDefinition_QualifiedValue<'_> {
    ...
    /// The range of values defined for continuous or ordinal observations that match the
    /// criteria of this set of qualified values.
    ...
    /// The category of range of values for continuous or ordinal observations that match
