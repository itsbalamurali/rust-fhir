...
impl ObservationDefinition_QuantitativeDetails<'_> {
    ...
    /// Factor for converting value expressed with primary unit to value expressed with
    /// secondary unit.
    ...
    /// Secondary unit used to report quantitative results of observations conforming to
    ...
    /// Primary unit used to report quantitative results of observations conforming to
    /// this ObservationDefinition.
