...
use crate::models::r5::OperationDefinition_Overload::OperationDefinition_Overload;
use crate::models::r5::OperationDefinition_Parameter::OperationDefinition_Parameter;
...
impl OperationDefinitionBuilder {
    ...
    pub fn _copyright<'a>(&'a mut self, val: Element) -> &'a mut OperationDefinitionBuilder {
    ...
    pub fn copyright<'a>(&'a mut self, val: &str) -> &'a mut OperationDefinitionBuilder {
    ...
    pub fn kind<'a>(&'a mut self, val: &str) -> &'a mut OperationDefinitionBuilder {
    ...
    pub fn status<'a>(&'a mut self, val: &str) -> &'a mut OperationDefinitionBuilder {
