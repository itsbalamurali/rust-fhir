...
use crate::models::r5::Patient_Communication::Patient_Communication;
use crate::models::r5::Patient_Contact::Patient_Contact;
use crate::models::r5::Patient_Link::Patient_Link;
...
impl Patient<'_> {
    ...
    /// Link to another patient or RelatedPErson resource that concerns the same actual
    /// patient.
...
impl PatientBuilder {
    ...
    pub fn gender<'a>(&'a mut self, val: &str) -> &'a mut PatientBuilder {
