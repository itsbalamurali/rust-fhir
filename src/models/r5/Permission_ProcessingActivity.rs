...
impl Permission_ProcessingActivity<'_> {
    ...
    /// If the processing is a transfer, or involves another party, we must capture where
    /// it the data allowed or expected to be shared - with a party or person. This can be
    /// a party instance or party type  § Purpose – a specific purpose of the data.
