...
use crate::models::r5::Person_Communication::Person_Communication;
use crate::models::r5::Person_Link::Person_Link;
...
impl Person<'_> {
    ...
    /// health.
    pub fn communication(&self) -> Option<Vec<Person_Communication>> {
        if let Some(Value::Array(val)) = self.value.get("communication") {
            return Some(
                val.into_iter()
                    .map(|e| Person_Communication {
                        value: Cow::Borrowed(e),
                    })
                    .collect::<Vec<_>>(),
            );
...
impl PersonBuilder {
    ...
    pub fn _deceased_boolean<'a>(&'a mut self, val: Element) -> &'a mut PersonBuilder {
        self.value["_deceasedBoolean"] = json!(val.value);
        return self;
    }

    pub fn _deceased_date_time<'a>(&'a mut self, val: Element) -> &'a mut PersonBuilder {
    ...
    pub fn deceased_boolean<'a>(&'a mut self, val: bool) -> &'a mut PersonBuilder {
        self.value["deceasedBoolean"] = json!(val);
        return self;
    }

    pub fn deceased_date_time<'a>(&'a mut self, val: &str) -> &'a mut PersonBuilder {
    ...
    pub fn gender<'a>(&'a mut self, val: &str) -> &'a mut PersonBuilder {
    ...
    pub fn marital_status<'a>(&'a mut self, val: CodeableConcept) -> &'a mut PersonBuilder {
    ...
    pub fn photo<'a>(&'a mut self, val: Vec<Attachment>) -> &'a mut PersonBuilder {
