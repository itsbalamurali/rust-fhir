...
#[derive(Debug)]
pub struct PlanDefinition_Output<'a> {
    pub(crate) value: Cow<'a, Value>,
}

impl PlanDefinition_Output<'_> {
    pub fn new(value: &Value) -> PlanDefinition_Output {
...
#[derive(Debug)]
pub struct PlanDefinition_OutputBuilder {
    pub(crate) value: Value,
}

impl PlanDefinition_OutputBuilder {
    pub fn build(&self) -> PlanDefinition_Output {
        PlanDefinition_Output {
            value: Cow::Owned(self.value.clone()),
        }
    }

    pub fn with(existing: PlanDefinition_Output) -> PlanDefinition_OutputBuilder {
        PlanDefinition_OutputBuilder {
            value: (*existing.value).clone(),
        }
    }

    pub fn new() -> PlanDefinition_OutputBuilder {
        let mut __value: Value = json!({});
        return PlanDefinition_OutputBuilder { value: __value };
    }

    pub fn _related_data<'a>(&'a mut self, val: Element) -> &'a mut PlanDefinition_OutputBuilder {
        self.value["_relatedData"] = json!(val.value);
        return self;
    }

    pub fn _title<'a>(&'a mut self, val: Element) -> &'a mut PlanDefinition_OutputBuilder {
    ...
    pub fn extension<'a>(
        &'a mut self,
        val: Vec<Extension>,
    ) -> &'a mut PlanDefinition_OutputBuilder {
        self.value["extension"] = json!(val.into_iter().map(|e| e.value).collect::<Vec<_>>());
        return self;
    }

    pub fn id<'a>(&'a mut self, val: &str) -> &'a mut PlanDefinition_OutputBuilder {
    ...
    pub fn related_data<'a>(&'a mut self, val: &str) -> &'a mut PlanDefinition_OutputBuilder {
    ...
    pub fn title<'a>(&'a mut self, val: &str) -> &'a mut PlanDefinition_OutputBuilder {
