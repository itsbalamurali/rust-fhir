...
use crate::models::r5::Practitioner_Qualification::Practitioner_Qualification;
...
impl PractitionerBuilder {
    ...
    pub fn _deceased_boolean<'a>(&'a mut self, val: Element) -> &'a mut PractitionerBuilder {
        self.value["_deceasedBoolean"] = json!(val.value);
        return self;
    }

    pub fn _deceased_date_time<'a>(&'a mut self, val: Element) -> &'a mut PractitionerBuilder {
    ...
    pub fn deceased_boolean<'a>(&'a mut self, val: bool) -> &'a mut PractitionerBuilder {
        self.value["deceasedBoolean"] = json!(val);
        return self;
    }

    pub fn deceased_date_time<'a>(&'a mut self, val: &str) -> &'a mut PractitionerBuilder {
    ...
    pub fn gender<'a>(&'a mut self, val: &str) -> &'a mut PractitionerBuilder {
