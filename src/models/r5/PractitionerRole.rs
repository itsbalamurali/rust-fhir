...
use crate::models::r5::PractitionerRole_AvailableTime::PractitionerRole_AvailableTime;
use crate::models::r5::PractitionerRole_NotAvailable::PractitionerRole_NotAvailable;
