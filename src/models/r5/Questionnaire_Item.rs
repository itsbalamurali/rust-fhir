...
use crate::models::r5::Questionnaire_AnswerOption::Questionnaire_AnswerOption;
use crate::models::r5::Questionnaire_EnableWhen::Questionnaire_EnableWhen;
use crate::models::r5::Questionnaire_Initial::Questionnaire_Initial;
use serde_json::json;
...
impl Questionnaire_Item<'_> {
    ...
    pub fn _answer_constraint(&self) -> Option<Element> {
        if let Some(val) = self.value.get("_answerConstraint") {
            return Some(Element {
    ...
    pub fn _disabled_display(&self) -> Option<Element> {
        if let Some(val) = self.value.get("_disabledDisplay") {
            return Some(Element {
                value: Cow::Borrowed(val),
            });
        }
    ...
    /// selected.
    pub fn answer_constraint(&self) -> Option<&str> {
        if let Some(Value::String(string)) = self.value.get("answerConstraint") {
            return Some(string);
        }
        return None;
    }
    ...
    /// (elementdefinition.html) that provides information about this item, including
    /// information that might otherwise be included in the instance of the Questionnaire
    /// resource. A detailed description of the construction of the URI is shown in
    ...
    pub fn disabled_display(&self) -> Option<&str> {
        if let Some(Value::String(string)) = self.value.get("disabledDisplay") {
            return Some(string);
        }
        return None;
    }
    ...
    /// be true.
    pub fn enable_behavior(&self) -> Option<&str> {
        if let Some(Value::String(string)) = self.value.get("enableBehavior") {
            return Some(string);
        }
        return None;
    }
    ...
    pub fn validate(&self) -> bool {
        if let Some(_val) = self._answer_constraint() {
            if !_val.validate() {
                return false;
            }
        }
        ...
        if let Some(_val) = self._disabled_display() {
            if !_val.validate() {
                return false;
            }
        }
        ...
        if let Some(_val) = self.answer_constraint() {}
        ...
        if let Some(_val) = self.disabled_display() {}
...
impl Questionnaire_ItemBuilder {
    ...
    pub fn _answer_constraint<'a>(&'a mut self, val: Element) -> &'a mut Questionnaire_ItemBuilder {
        self.value["_answerConstraint"] = json!(val.value);
        return self;
    }
    ...
    pub fn _disabled_display<'a>(&'a mut self, val: Element) -> &'a mut Questionnaire_ItemBuilder {
        self.value["_disabledDisplay"] = json!(val.value);
        return self;
    }
    ...
    pub fn answer_constraint<'a>(&'a mut self, val: &str) -> &'a mut Questionnaire_ItemBuilder {
        self.value["answerConstraint"] = json!(val);
        return self;
    }
    ...
    pub fn disabled_display<'a>(&'a mut self, val: &str) -> &'a mut Questionnaire_ItemBuilder {
        self.value["disabledDisplay"] = json!(val);
        return self;
    }

    pub fn enable_behavior<'a>(&'a mut self, val: &str) -> &'a mut Questionnaire_ItemBuilder {
        self.value["enableBehavior"] = json!(val);
        return self;
    }
    ...
    pub fn fhir_type<'a>(&'a mut self, val: &str) -> &'a mut Questionnaire_ItemBuilder {
