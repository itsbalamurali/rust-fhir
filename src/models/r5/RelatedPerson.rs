...
use crate::models::r5::RelatedPerson_Communication::RelatedPerson_Communication;
use crate::models::r5::ResourceList::ResourceList;
use serde_json::json;
use serde_json::value::Value;
use std::borrow::Cow;

/// Information about a person that is involved in the care for a patient, but who is
...
impl RelatedPersonBuilder {
    ...
    pub fn gender<'a>(&'a mut self, val: &str) -> &'a mut RelatedPersonBuilder {
