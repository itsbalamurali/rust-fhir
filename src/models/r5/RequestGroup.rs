...
use crate::models::r5::RequestGroup_Action::RequestGroup_Action;
...
impl RequestGroupBuilder {
    ...
    pub fn goal<'a>(&'a mut self, val: Vec<Reference>) -> &'a mut RequestGroupBuilder {
    ...
    pub fn reason<'a>(&'a mut self, val: Vec<CodeableReference>) -> &'a mut RequestGroupBuilder {
