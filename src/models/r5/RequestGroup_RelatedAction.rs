...
impl RequestGroup_RelatedActionBuilder {
    ...
    pub fn _target_id<'a>(&'a mut self, val: Element) -> &'a mut RequestGroup_RelatedActionBuilder {
    ...
    pub fn target_id<'a>(&'a mut self, val: &str) -> &'a mut RequestGroup_RelatedActionBuilder {
