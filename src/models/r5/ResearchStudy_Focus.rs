...
impl ResearchStudy_Focus<'_> {
    ...
    /// with the intention to affect biological systems in a way that can be measured by
    /// an assay.
    ...
    /// Identification of product under study.  This may be any combination of code and/
    /// or name.
