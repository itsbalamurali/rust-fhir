...
impl ResearchStudy_ObjectiveBuilder {
    ...
    pub fn _description<'a>(&'a mut self, val: Element) -> &'a mut ResearchStudy_ObjectiveBuilder {
    ...
    pub fn description<'a>(&'a mut self, val: &str) -> &'a mut ResearchStudy_ObjectiveBuilder {
