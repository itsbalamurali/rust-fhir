...
use crate::models::r5::RiskAssessment_Prediction::RiskAssessment_Prediction;
use serde_json::json;
...
impl RiskAssessmentBuilder {
    ...
    pub fn reason<'a>(&'a mut self, val: Vec<CodeableReference>) -> &'a mut RiskAssessmentBuilder {
