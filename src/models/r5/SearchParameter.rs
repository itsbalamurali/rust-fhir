...
use crate::models::r5::SearchParameter_Component::SearchParameter_Component;
...
impl SearchParameter<'_> {
    ...
    /// reference to a resource which matches the chained parameter value. Values for
    /// this field should be drawn from SearchParameter.code for a parameter on the target
    /// resource type.
    ...
    pub fn comparator(&self) -> Option<Vec<&str>> {
        if let Some(Value::Array(val)) = self.value.get("comparator") {
            return Some(
                val.into_iter()
                    .map(|e| e.as_str().unwrap())
                    .collect::<Vec<_>>(),
    ...
    /// xpath query.
    pub fn xpath_usage(&self) -> Option<&str> {
        if let Some(Value::String(string)) = self.value.get("xpathUsage") {
            return Some(string);
        }
        return None;
    }
...
impl SearchParameterBuilder {
    ...
    pub fn _copyright<'a>(&'a mut self, val: Element) -> &'a mut SearchParameterBuilder {
    ...
    pub fn _title<'a>(&'a mut self, val: Element) -> &'a mut SearchParameterBuilder {
    ...
    pub fn comparator<'a>(&'a mut self, val: Vec<&str>) -> &'a mut SearchParameterBuilder {
        self.value["comparator"] = json!(val);
        return self;
    }
    ...
    pub fn copyright<'a>(&'a mut self, val: &str) -> &'a mut SearchParameterBuilder {
    ...
    pub fn identifier<'a>(&'a mut self, val: Vec<Identifier>) -> &'a mut SearchParameterBuilder {
    ...
    pub fn modifier<'a>(&'a mut self, val: Vec<&str>) -> &'a mut SearchParameterBuilder {
    ...
    pub fn status<'a>(&'a mut self, val: &str) -> &'a mut SearchParameterBuilder {
    ...
    pub fn title<'a>(&'a mut self, val: &str) -> &'a mut SearchParameterBuilder {
        self.value["title"] = json!(val);
        return self;
    }

    pub fn fhir_type<'a>(&'a mut self, val: &str) -> &'a mut SearchParameterBuilder {
    ...
    pub fn xpath_usage<'a>(&'a mut self, val: &str) -> &'a mut SearchParameterBuilder {
        self.value["xpathUsage"] = json!(val);
        return self;
    }
}
