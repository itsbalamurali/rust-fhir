...
use crate::models::r5::SpecimenDefinition_Container::SpecimenDefinition_Container;
use crate::models::r5::SpecimenDefinition_Handling::SpecimenDefinition_Handling;
use serde_json::json;
...
impl SpecimenDefinition_TypeTested<'_> {
    ...
    pub fn _single_use(&self) -> Option<Element> {
        if let Some(val) = self.value.get("_singleUse") {
            return Some(Element {
                value: Cow::Borrowed(val),
            });
        }
    ...
    pub fn preference(&self) -> Option<&str> {
        if let Some(Value::String(string)) = self.value.get("preference") {
            return Some(string);
        }
        return None;
    }
    ...
    pub fn single_use(&self) -> Option<bool> {
        if let Some(val) = self.value.get("singleUse") {
            return Some(val.as_bool().unwrap());
        }
        return None;
    }
    ...
    /// of these.
    pub fn testing_destination(&self) -> Option<Vec<CodeableConcept>> {
        if let Some(Value::Array(val)) = self.value.get("testingDestination") {
            return Some(
                val.into_iter()
                    .map(|e| CodeableConcept {
                        value: Cow::Borrowed(e),
    ...
    pub fn validate(&self) -> bool {
        ...
        if let Some(_val) = self._single_use() {
            if !_val.validate() {
                return false;
            }
        }
        ...
        if let Some(_val) = self.single_use() {}
        if let Some(_val) = self.testing_destination() {
            if !_val.into_iter().map(|e| e.validate()).all(|x| x == true) {
                return false;
            }
        }
...
impl SpecimenDefinition_TypeTestedBuilder {
    ...
    pub fn _single_use<'a>(
        &'a mut self,
        val: Element,
    ) -> &'a mut SpecimenDefinition_TypeTestedBuilder {
        self.value["_singleUse"] = json!(val.value);
        return self;
    }
    ...
    pub fn preference<'a>(&'a mut self, val: &str) -> &'a mut SpecimenDefinition_TypeTestedBuilder {
        self.value["preference"] = json!(val);
        return self;
    }
    ...
    pub fn single_use<'a>(&'a mut self, val: bool) -> &'a mut SpecimenDefinition_TypeTestedBuilder {
        self.value["singleUse"] = json!(val);
        return self;
    }

    pub fn testing_destination<'a>(
        &'a mut self,
        val: Vec<CodeableConcept>,
    ) -> &'a mut SpecimenDefinition_TypeTestedBuilder {
        self.value["testingDestination"] =
            json!(val.into_iter().map(|e| e.value).collect::<Vec<_>>());
        return self;
    }
