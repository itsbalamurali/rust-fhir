...
impl Specimen_Collection<'_> {
    ...
    pub fn device(&self) -> Option<CodeableReference> {
    ...
    pub fn procedure(&self) -> Option<Reference> {
...
impl Specimen_CollectionBuilder {
    ...
    pub fn device<'a>(&'a mut self, val: CodeableReference) -> &'a mut Specimen_CollectionBuilder {
    ...
    pub fn procedure<'a>(&'a mut self, val: Reference) -> &'a mut Specimen_CollectionBuilder {
