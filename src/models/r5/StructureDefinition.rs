...
use crate::models::r5::StructureDefinition_Context::StructureDefinition_Context;
use crate::models::r5::StructureDefinition_Differential::StructureDefinition_Differential;
use crate::models::r5::StructureDefinition_Mapping::StructureDefinition_Mapping;
use crate::models::r5::StructureDefinition_Snapshot::StructureDefinition_Snapshot;
...
impl StructureDefinition<'_> {
    ...
    pub fn derivation(&self) -> Option<&str> {
        if let Some(Value::String(string)) = self.value.get("derivation") {
            return Some(string);
        }
        return None;
    }
    ...
    /// e.g. [publication].[major].[minor], which is 5.0.0-snapshot1. for this version.
...
impl StructureDefinitionBuilder {
    ...
    pub fn derivation<'a>(&'a mut self, val: &str) -> &'a mut StructureDefinitionBuilder {
        self.value["derivation"] = json!(val);
        return self;
    }
    ...
    pub fn fhir_version<'a>(&'a mut self, val: &str) -> &'a mut StructureDefinitionBuilder {
    ...
    pub fn kind<'a>(&'a mut self, val: &str) -> &'a mut StructureDefinitionBuilder {
    ...
    pub fn status<'a>(&'a mut self, val: &str) -> &'a mut StructureDefinitionBuilder {
