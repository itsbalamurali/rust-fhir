...
impl StructureMap_Dependent<'_> {
    ...
    pub fn parameter(&self) -> Vec<StructureMap_Parameter> {
        self.value
            .get("parameter")
            .unwrap()
            .as_array()
...
impl StructureMap_DependentBuilder {
    ...
    pub fn new(parameter: Vec<StructureMap_Parameter>) -> StructureMap_DependentBuilder {
        let mut __value: Value = json!({});
        __value["parameter"] = json!(parameter.into_iter().map(|e| e.value).collect::<Vec<_>>());
