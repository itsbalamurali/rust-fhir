...
impl StructureMap_ParameterBuilder {
    ...
    pub fn _value_date<'a>(&'a mut self, val: Element) -> &'a mut StructureMap_ParameterBuilder {
    ...
    pub fn _value_time<'a>(&'a mut self, val: Element) -> &'a mut StructureMap_ParameterBuilder {
    ...
    pub fn value_date<'a>(&'a mut self, val: &str) -> &'a mut StructureMap_ParameterBuilder {
        self.value["valueDate"] = json!(val);
        return self;
    }

    pub fn value_date_time<'a>(&'a mut self, val: &str) -> &'a mut StructureMap_ParameterBuilder {
    ...
    pub fn value_time<'a>(&'a mut self, val: &str) -> &'a mut StructureMap_ParameterBuilder {
