...
use crate::models::r5::Substance_Ingredient::Substance_Ingredient;
use serde_json::json;
...
impl SubstanceBuilder {
    ...
    pub fn new(code: CodeableReference) -> SubstanceBuilder {
    ...
    pub fn _expiry<'a>(&'a mut self, val: Element) -> &'a mut SubstanceBuilder {
    ...
    pub fn _instance<'a>(&'a mut self, val: Element) -> &'a mut SubstanceBuilder {
    ...
    pub fn expiry<'a>(&'a mut self, val: &str) -> &'a mut SubstanceBuilder {
    ...
    pub fn instance<'a>(&'a mut self, val: bool) -> &'a mut SubstanceBuilder {
    ...
    pub fn quantity<'a>(&'a mut self, val: Quantity) -> &'a mut SubstanceBuilder {
        self.value["quantity"] = json!(val.value);
        return self;
    }

    pub fn status<'a>(&'a mut self, val: &str) -> &'a mut SubstanceBuilder {
