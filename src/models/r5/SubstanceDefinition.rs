...
use crate::models::r5::SubstanceDefinition_Code::SubstanceDefinition_Code;
use crate::models::r5::SubstanceDefinition_Moiety::SubstanceDefinition_Moiety;
use crate::models::r5::SubstanceDefinition_MolecularWeight::SubstanceDefinition_MolecularWeight;
use crate::models::r5::SubstanceDefinition_Name::SubstanceDefinition_Name;
use crate::models::r5::SubstanceDefinition_Property::SubstanceDefinition_Property;
use crate::models::r5::SubstanceDefinition_Relationship::SubstanceDefinition_Relationship;
use crate::models::r5::SubstanceDefinition_SourceMaterial::SubstanceDefinition_SourceMaterial;
use crate::models::r5::SubstanceDefinition_Structure::SubstanceDefinition_Structure;
use serde_json::json;
...
impl SubstanceDefinitionBuilder {
    ...
    pub fn nucleic_acid<'a>(&'a mut self, val: Reference) -> &'a mut SubstanceDefinitionBuilder {
        self.value["nucleicAcid"] = json!(val.value);
        return self;
    }

    pub fn polymer<'a>(&'a mut self, val: Reference) -> &'a mut SubstanceDefinitionBuilder {
    ...
    pub fn protein<'a>(&'a mut self, val: Reference) -> &'a mut SubstanceDefinitionBuilder {
