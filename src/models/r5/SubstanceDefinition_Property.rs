...
#[derive(Debug)]
pub struct SubstanceDefinition_Property<'a> {
    pub(crate) value: Cow<'a, Value>,
}

impl SubstanceDefinition_Property<'_> {
    pub fn new(value: &Value) -> SubstanceDefinition_Property {
...
#[derive(Debug)]
pub struct SubstanceDefinition_PropertyBuilder {
    pub(crate) value: Value,
}

impl SubstanceDefinition_PropertyBuilder {
    pub fn build(&self) -> SubstanceDefinition_Property {
        SubstanceDefinition_Property {
            value: Cow::Owned(self.value.clone()),
        }
    }

    pub fn with(existing: SubstanceDefinition_Property) -> SubstanceDefinition_PropertyBuilder {
        SubstanceDefinition_PropertyBuilder {
            value: (*existing.value).clone(),
        }
    }

    pub fn new(fhir_type: CodeableConcept) -> SubstanceDefinition_PropertyBuilder {
        let mut __value: Value = json!({});
        __value["type"] = json!(fhir_type.value);
        return SubstanceDefinition_PropertyBuilder { value: __value };
    }

    pub fn _value_boolean<'a>(
        &'a mut self,
        val: Element,
    ) -> &'a mut SubstanceDefinition_PropertyBuilder {
    ...
    pub fn id<'a>(&'a mut self, val: &str) -> &'a mut SubstanceDefinition_PropertyBuilder {
    ...
    pub fn value_date<'a>(&'a mut self, val: &str) -> &'a mut SubstanceDefinition_PropertyBuilder {
