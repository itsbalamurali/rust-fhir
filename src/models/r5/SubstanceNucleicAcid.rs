...
use crate::models::r5::SubstanceNucleicAcid_Subunit::SubstanceNucleicAcid_Subunit;
use serde_json::json;
...
impl SubstanceNucleicAcid<'_> {
    ...
    /// or DNA. The number associated with the subunit followed by the number associated
    /// to the residue shall be specified in increasing order. The underscore “” shall be
