...
use crate::models::r5::SubstancePolymer_StartingMaterial::SubstancePolymer_StartingMaterial;
use serde_json::json;
...
impl SubstancePolymer_MonomerSet<'_> {
    ...
    /// Captures the type of ratio to the entire polymer, e.g. Monomer/Polymer ratio, SRU/
    /// Polymer Ratio.
