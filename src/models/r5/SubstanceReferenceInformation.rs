...
use crate::models::r5::SubstanceReferenceInformation_Gene::SubstanceReferenceInformation_Gene;
use crate::models::r5::SubstanceReferenceInformation_GeneElement::SubstanceReferenceInformation_GeneElement;
use crate::models::r5::SubstanceReferenceInformation_Target::SubstanceReferenceInformation_Target;
use serde_json::json;
