...
use crate::models::r5::SupplyRequest_Parameter::SupplyRequest_Parameter;
...
impl SupplyRequestBuilder {
    ...
    pub fn new(item: CodeableReference, quantity: Quantity) -> SupplyRequestBuilder {
    ...
    pub fn based_on<'a>(&'a mut self, val: Vec<Reference>) -> &'a mut SupplyRequestBuilder {
    ...
    pub fn reason<'a>(&'a mut self, val: Vec<CodeableReference>) -> &'a mut SupplyRequestBuilder {
    ...
    pub fn status<'a>(&'a mut self, val: &str) -> &'a mut SupplyRequestBuilder {
