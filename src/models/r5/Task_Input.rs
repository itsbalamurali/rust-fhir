...
impl Task_InputBuilder {
    ...
    pub fn _value_integer_6_4<'a>(&'a mut self, val: Element) -> &'a mut Task_InputBuilder {
    ...
    pub fn value_integer_6_4<'a>(&'a mut self, val: &str) -> &'a mut Task_InputBuilder {
    ...
    pub fn value_ratio_range<'a>(&'a mut self, val: RatioRange) -> &'a mut Task_InputBuilder {
