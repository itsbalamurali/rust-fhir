...
impl Task_Output<'_> {
    ...
    pub fn _value_integer_64(&self) -> Option<Element> {
        if let Some(val) = self.value.get("_valueInteger64") {
            return Some(Element {
                value: Cow::Borrowed(val),
            });
        }
    ...
    /// The value of the Output parameter as a basic type.
    pub fn value_codeable_reference(&self) -> Option<CodeableReference> {
        if let Some(val) = self.value.get("valueCodeableReference") {
    ...
    /// The value of the Output parameter as a basic type.
    pub fn value_integer_64(&self) -> Option<&str> {
        if let Some(Value::String(string)) = self.value.get("valueInteger64") {
            return Some(string);
        }
        return None;
    }
    ...
    /// The value of the Output parameter as a basic type.
    pub fn value_ratio_range(&self) -> Option<RatioRange> {
        if let Some(val) = self.value.get("valueRatioRange") {
    ...
    pub fn validate(&self) -> bool {
        ...
        if let Some(_val) = self._value_integer_64() {
            if !_val.validate() {
                return false;
            }
        }
        ...
        if let Some(_val) = self.value_codeable_reference() {
            if !_val.validate() {
                return false;
            }
        }
        ...
        if let Some(_val) = self.value_integer_64() {}
        ...
        if let Some(_val) = self.value_ratio_range() {
            if !_val.validate() {
                return false;
            }
        }
...
impl Task_OutputBuilder {
    ...
    pub fn _value_base_64_binary<'a>(&'a mut self, val: Element) -> &'a mut Task_OutputBuilder {
    ...
    pub fn _value_integer_64<'a>(&'a mut self, val: Element) -> &'a mut Task_OutputBuilder {
        self.value["_valueInteger64"] = json!(val.value);
        return self;
    }
    ...
    pub fn value_base_64_binary<'a>(&'a mut self, val: &str) -> &'a mut Task_OutputBuilder {
    ...
    pub fn value_codeable_reference<'a>(
        &'a mut self,
        val: CodeableReference,
    ) -> &'a mut Task_OutputBuilder {
        self.value["valueCodeableReference"] = json!(val.value);
        return self;
    }
    ...
    pub fn value_integer_64<'a>(&'a mut self, val: &str) -> &'a mut Task_OutputBuilder {
        self.value["valueInteger64"] = json!(val);
        return self;
    }
    ...
    pub fn value_ratio_range<'a>(&'a mut self, val: RatioRange) -> &'a mut Task_OutputBuilder {
        self.value["valueRatioRange"] = json!(val.value);
        return self;
    }
