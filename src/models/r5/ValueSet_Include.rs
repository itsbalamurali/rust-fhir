...
use crate::models::r5::ValueSet_Concept::ValueSet_Concept;
use crate::models::r5::ValueSet_Filter::ValueSet_Filter;
use serde_json::json;
...
impl ValueSet_IncludeBuilder {
    ...
    pub fn _copyright<'a>(&'a mut self, val: Element) -> &'a mut ValueSet_IncludeBuilder {
    ...
    pub fn copyright<'a>(&'a mut self, val: &str) -> &'a mut ValueSet_IncludeBuilder {
