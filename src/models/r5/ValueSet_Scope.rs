...
impl ValueSet_Scope<'_> {
    ...
    /// This can be the information about clinical relevancy or the statement about
    /// the general focus of the Value Set, such as a description of types of messages,
