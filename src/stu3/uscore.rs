...
pub struct UsCoreAllergyintolerance {
    ...
    pub verification_status: ::core::option::Option<super::core::AllergyIntoleranceVerificationStatusCode>,
...
pub mod us_core_careplan {
    ...
    pub mod activity {
        ...
        pub struct Detail {
            ...
            /// | unknown
            #[prost(message, optional, tag="10")]
            pub status: ::core::option::Option<super::super::super::core::CarePlanActivityStatusCode>,
